 ...
 * ============================================================================*/
package vendor.qti.hardware.bluetooth_sar;
...
interface IBluetoothSar {
   ...
   *
   * @param cap Bluetooth Tx cap. Range is between 0 and 80 units(i.e. 0 to 20 dBm),
   ...
   * scenarios.
   *
   * @param brCap Bluetooth Tx cap. Range is between 0 and 80 units(i.e. 0 to 20 dBm),
   * each unit is 0.25 dBm.
   * @param edrCap Bluetooth Tx cap. Range is between 0 and 80 units(i.e. 0 to 20 dBm),
   * each unit is 0.25 dBm.
   * @param bleCap Bluetooth Tx cap. Range is between 0 and 80 unitsi.e. 0 to 20 dBm),
   * each unit is 0.25 dBm.
   */
   ...
   * 80 units(i.e. 0 to 20 dBm), each unit is 0.25 dBm.
   ...
   * between 0 and 80 units(i.e. 0 to 20 dBm), each unit is 0.25 dBm.
   */
