...
#ifndef SECURE_PROCESSOR_V1_CONFIG_H
#define SECURE_PROCESSOR_V1_CONFIG_H
 ...
 */
class SecureProcessorConfigAidl {
  public:
   /**
    ...
    *                  to be added)
    */
    SecureProcessorConfigAidl(uint32_t entryLimit, uint32_t dataLimit = 64);
    ...
    */
    SecureProcessorConfigAidl(void *buffer);
    ...
    *   backing buffer over AIDL to hal service (and vice versa).
    *
