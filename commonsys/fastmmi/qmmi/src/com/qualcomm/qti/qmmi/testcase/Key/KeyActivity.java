            ...
            if (Intent.ACTION_CLOSE_SYSTEM_DIALOGS.equals(action)) {
                ...
                String reason = arg1.getStringExtra(SYSTEM_DIALOG_REASON_KEY);
                 if (SYSTEM_DIALOG_REASON_HOME_KEY.equals(reason)) {
                    ...
                    //Execute tasks while the main thread is idle
                    Looper.myQueue().addIdleHandler(new MessageQueue.IdleHandler() {
                        @Override
                        public boolean queueIdle() {
                            // Switch to UI thread in Handler for UI update
                     ...
                     // remove startSelf action of KeyActivity here
                     // since QuickstepLauncher Activity won't launch & visible when click recentApp key
                     // startSelf();
