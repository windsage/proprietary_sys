...
#include <aidl/vendor/qti/hardware/factory/IFactory.h>

using IFactoryHidl = ::vendor::qti::hardware::factory::V1_1::IFactory;
using FactoryResultHidl = ::vendor::qti::hardware::factory::V1_0::FactoryResult;
using IResultTypeHidl = ::vendor::qti::hardware::factory::V1_0::IResultType;
using WriteFileReqHidl = ::vendor::qti::hardware::factory::V1_0::WriteFileReq;
using ReadFileResultHidl = ::vendor::qti::hardware::factory::V1_0::ReadFileResult;
using ReadFileReqHidl = ::vendor::qti::hardware::factory::V1_0::ReadFileReq;
...
using IFactoryAidl = ::aidl::vendor::qti::hardware::factory::IFactory;
using FactoryResultAidl = ::aidl::vendor::qti::hardware::factory::FactoryResult;
using IResultTypeAidl = ::aidl::vendor::qti::hardware::factory::IResultType;
using WriteFileReqAidl = ::aidl::vendor::qti::hardware::factory::WriteFileReq;
using ReadFileResultAidl = ::aidl::vendor::qti::hardware::factory::ReadFileResult;
using ReadFileReqAidl = ::aidl::vendor::qti::hardware::factory::ReadFileReq;
