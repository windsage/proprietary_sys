...
public class BluetoothHeadsetProxy {
    ...
    public void phoneStateChangedDsDa(int numActive, int numHeld, int callState, String number,
        ...
        mBluetoothHeadset.phoneStateChangedDsDa(numActive, numHeld, callState, number, type,
                name);
    }
    ...
    public void clccResponseDsDa(int index, int direction, int status, int mode, boolean mpty,
        ...
        mBluetoothHeadset.clccResponseDsDa(index, direction, status, mode, mpty, number, type);
    }
