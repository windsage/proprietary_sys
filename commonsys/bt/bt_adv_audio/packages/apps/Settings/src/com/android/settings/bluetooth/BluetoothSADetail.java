...
public class BluetoothSADetail extends DeviceListPreferenceFragment implements
    ...
    BleBroadcastAudioScanAssistCallback mScanAssistCallback = new BleBroadcastAudioScanAssistCallback() {
        ...
        public void onBleBroadcastSourceFound(ScanResult res) {
            ...
            // BluetoothDevicePreference pref = devicePreferenceMap.get(cachedDevice);
            // if (pref != null) {
    ...
    void createDevicePreference(CachedBluetoothDevice cachedDevice) {
        ...
        //devicePreferenceMap.put(cachedDevice, preference);
        // notifyChanged
        mAvailableDevicesCategory.setProgress(mScanning);
    }
    ...
    public void enableScanning() {
        ...
        if (mScanAssistManager != null && mScanning == false) {
