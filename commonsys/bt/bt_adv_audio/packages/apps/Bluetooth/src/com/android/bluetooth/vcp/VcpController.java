...
public class VcpController {
    ...
    private VcpController(Context context) {
        ...
        if (mPtsTest) {
            ...
            context.registerReceiver(mVcpControllerTestReceiver, filter2, Context.RECEIVER_EXPORTED);
        }
    }
    ...
    public void setVolumeControlSevice(VolumeControlService volumeControlService) {
        ...
        mVolumeControlService = volumeControlService;
    }
    ...
    int getCsipSetId(BluetoothDevice device, ParcelUuid uuid) {
        ...
        return csipWrapper.getRemoteDeviceGroupId(device, uuid);
    }
    ...
    void notifyVolumeChanged(BluetoothDevice device, int volume, int audioType) {
        ...
        if (ApmConst.getQtiLeAudioEnabled() || mPtsTest) {
