        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case LOCK:
                    ...
                    ///*_CSIP
                    mCsipWrapper.setLockValue(mBCService.mCsipAppId, mSetId, null, BluetoothDeviceGroup.ACCESS_GRANTED);
                    //_CSIP*/
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case UNLOCK:
                    ...
                    ///*_CSIP
                    mCsipWrapper.setLockValue(mBCService.mCsipAppId, mSetId, null, BluetoothDeviceGroup.ACCESS_RELEASED);
                ...
                case BASS_GRP_SET_BCAST_CODE:
                    srcInfo = (BleBroadcastSourceInfo)message.obj;
                    if (mBCService != null) {
                        mBCService.setBroadcastCode(mDevice, mMemberDevices, srcInfo, false);
                        transitionTo(mLockedProcessing);
                    } else {
                        log("no Bassclient service handle");
                    }
