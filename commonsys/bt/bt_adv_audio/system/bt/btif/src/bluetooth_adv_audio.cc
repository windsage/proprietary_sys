...
#ifdef VLOC_FEATURE
#include <hardware/bluetooth_csc_interface.h>
#include <hardware/bluetooth_csc_callbacks.h>
#endif
/*******************************************************************************
 *  Externs
 ******************************************************************************/
...
#ifdef VLOC_FEATURE
using bluetooth::csclient::CsClientInterface;
extern CsClientInterface *btif_cs_client_get_interface();
#endif
...
#ifdef VLOC_FEATURE
  if (is_profile(profile_id, BT_PROFILE_CS_CLIENT_ID)) {
    return btif_cs_client_get_interface();
  }
#endif
  return NULL;
}
