...
class CallControllerImpl : public CallController {
  ...
  CallControllerImpl(bluetooth::call_control::CallControllerCallbacks* callback,
    ...
    if (inband_ring_support) {
      StatusFlags.supported_flags =  (StatusFlags.supported_flags & 0x0000) |
                                                       INBAND_RINGTONE_FEATURE_BIT;
    } else {
  ...
  void CallState(int len, std::vector<uint8_t> call_state_list) {
    ...
    for (int k=0; k<len; k++) {
      LOG(INFO) << __func__ << ": " << k
                            <<", index: " << (unsigned)call_state_list[3*k + 0]
      ...
      if (CallStateOp.state == CCS_STATE_DISCONNECTED) {
        ...
        if (gIsTerminatedInitiatedFromClient &&
            CallStateOp.index == gTerminateIntiatedIndex) {
        ...
        std::map<uint8_t, tCCS_BEARER_LIST_CURRENT_CALLS>::iterator i =
                                           BlccInfolist.find(BlccInfo.call_index);
        ...
        std::map<uint8_t, tCCS_CALL_STATE>::iterator j =
                                         CallStatelist.find(CallStateOp.index);
  ...
  void BearerInfoName(uint8_t* name) {
    ...
    if (gIsPtsTestEnabled) {
      ...
      if (StatusFlags.supported_flags)
        UpdateStatusFlags(0);
      else
        UpdateStatusFlags(1);
  ...
  void UpdateStatusFlags(uint16_t status_flag) {
  ...
  void CallControlResponse(uint8_t op, uint8_t index, uint32_t status,
  ...
  void ConnectionStateCallback(uint8_t state,  const RawAddress&  address) {
    LOG(INFO) << __func__ << ": state: " << loghex(state);
    callbacks->ConnectionStateCallback(state, address);
  }

  void CallControlPointChange(uint8_t op, uint8_t* indices, int count,
                              char* uri, const RawAddress&  address) {
...
void  CallController::Initialize(bluetooth::call_control::CallControllerCallbacks* callbacks,
  ...
  if (cc_instance) {
    ...
    cc_instance = new CallControllerImpl(callbacks, uuid, max_ccs_clients,
...
static std::vector<btgatt_db_element_t> CcAddService(int server_if) {
  ...
  bearer_provider_name_char.properties = GATT_CHAR_PROP_BIT_READ|
                                         GATT_CHAR_PROP_BIT_NOTIFY;
  bearer_provider_name_char.permissions = GATT_PERM_READ_ENCRYPTED;
  ...
  bearer_provider_name_desc.permissions = GATT_PERM_READ_ENCRYPTED|GATT_PERM_WRITE_ENCRYPTED;
  ...
  bearer_technology_char.properties = GATT_CHAR_PROP_BIT_READ|
                                      GATT_CHAR_PROP_BIT_NOTIFY;
  bearer_technology_char.permissions = GATT_PERM_READ_ENCRYPTED;
  ...
  bearer_technology_desc.permissions = GATT_PERM_READ_ENCRYPTED|GATT_PERM_WRITE_ENCRYPTED;
  ...
  gtbs_cc_optional_opcode_char.permissions = GATT_PERM_READ_ENCRYPTED;
  ccs_services.push_back(gtbs_cc_optional_opcode_char);
  ccsControlServiceInfo.call_control_point_opcode_supported_uuid =
  ...
  gtbs_call_state_char.properties = GATT_CHAR_PROP_BIT_READ|
                                    GATT_CHAR_PROP_BIT_NOTIFY;
  gtbs_call_state_char.permissions = GATT_PERM_READ_ENCRYPTED;
  ...
  gtbs_call_state_desc.permissions = GATT_PERM_READ_ENCRYPTED|GATT_PERM_WRITE_ENCRYPTED;
  ...
  gtbs_call_control_point_char.properties = GATT_CHAR_PROP_BIT_WRITE|
                                            GATT_CHAR_PROP_BIT_NOTIFY|
                                            GATT_CHAR_PROP_BIT_WRITE_NR;
  gtbs_call_control_point_char.permissions = GATT_PERM_WRITE_ENCRYPTED;
  ...
  gtbs_call_control_point_desc.permissions = GATT_PERM_READ_ENCRYPTED|GATT_PERM_WRITE_ENCRYPTED;
  ...
  gtbs_bearer_uci_char.permissions = GATT_PERM_READ_ENCRYPTED;
  ...
  gtbs_bearer_URI_schemes_char.properties = GATT_CHAR_PROP_BIT_READ|
                                            GATT_CHAR_PROP_BIT_NOTIFY;
  gtbs_bearer_URI_schemes_char.permissions = GATT_PERM_READ_ENCRYPTED;
  ...
  gtbs_bearer_URI_schemes_desc.permissions = GATT_PERM_READ_ENCRYPTED|GATT_PERM_WRITE_ENCRYPTED;
  ...
  gtbs_signal_strength_char.properties = GATT_CHAR_PROP_BIT_READ|
                                         GATT_CHAR_PROP_BIT_NOTIFY;
  gtbs_signal_strength_char.permissions = GATT_PERM_READ_ENCRYPTED;
  ...
  gtbs_signal_strength_desc.permissions = GATT_PERM_READ_ENCRYPTED|GATT_PERM_WRITE_ENCRYPTED;
  ...
  gtbs_signal_strength_report_interval_char.properties = GATT_CHAR_PROP_BIT_READ|
                                                         GATT_CHAR_PROP_BIT_WRITE|
                                                         GATT_CHAR_PROP_BIT_WRITE_NR;
  gtbs_signal_strength_report_interval_char.permissions = GATT_PERM_READ_ENCRYPTED|GATT_PERM_WRITE_ENCRYPTED;
  ccs_services.push_back(gtbs_signal_strength_report_interval_char);
  ccsControlServiceInfo.bearer_signal_strength_report_interval_uuid =
                                          gtbs_signal_strength_report_interval_char.uuid;
  ...
  gtbs_list_current_calls_char.properties = GATT_CHAR_PROP_BIT_READ|
                                            GATT_CHAR_PROP_BIT_NOTIFY;
  gtbs_list_current_calls_char.permissions = GATT_PERM_READ_ENCRYPTED;
  ...
  gtbs_list_current_calls_desc.permissions = GATT_PERM_READ_ENCRYPTED|GATT_PERM_WRITE_ENCRYPTED;
  ...
  gtbs_call_status_flags_char.properties = GATT_CHAR_PROP_BIT_READ|
                                           GATT_CHAR_PROP_BIT_NOTIFY;
  gtbs_call_status_flags_char.permissions = GATT_PERM_READ_ENCRYPTED;
  ...
  gtbs_call_status_flags_desc.permissions = GATT_PERM_READ_ENCRYPTED|GATT_PERM_WRITE_ENCRYPTED;
  ...
  gtbs_incomingcall_target_bearer_URI_char.properties = GATT_CHAR_PROP_BIT_READ|
                                                        GATT_CHAR_PROP_BIT_NOTIFY;
  gtbs_incomingcall_target_bearer_URI_char.permissions = GATT_PERM_READ_ENCRYPTED;
  ccs_services.push_back(gtbs_incomingcall_target_bearer_URI_char);
  ccsControlServiceInfo.incoming_call_target_beareruri_uuid =
                                     gtbs_incomingcall_target_bearer_URI_char.uuid;
  ...
  gtbs_incomingcall_target_bearer_URI_desc.permissions = GATT_PERM_READ_ENCRYPTED|GATT_PERM_WRITE_ENCRYPTED;
  ...
  gtbs_incomingcall_char.permissions = GATT_PERM_READ_ENCRYPTED;
  ...
  gtbs_incomingcall_desc.permissions = GATT_PERM_READ_ENCRYPTED|GATT_PERM_WRITE_ENCRYPTED;
  ...
  ccsControlServiceInfo.call_termination_reason_uuid =
                                        gtbs_call_termination_reason_char.uuid;
  ...
  gtbs_call_termination_reason_desc.permissions = GATT_PERM_READ_ENCRYPTED|GATT_PERM_WRITE_ENCRYPTED;
  ...
  gtbs_call_friendly_name_char.properties = GATT_CHAR_PROP_BIT_READ|
                                            GATT_CHAR_PROP_BIT_NOTIFY;
  gtbs_call_friendly_name_char.permissions = GATT_PERM_READ_ENCRYPTED;
  ...
  gtbs_call_friendly_name_desc.permissions =  GATT_PERM_READ_ENCRYPTED|GATT_PERM_WRITE_ENCRYPTED;
  ...
  gtbs_ccid_char.permissions = GATT_PERM_READ_ENCRYPTED;
...
static void SSReportingTimerExpired(void *data) {
  ...
  if(!cc_instance) {
    LOG(INFO) << __func__ << ": cc_instance is NULL, return";
    return;
  }
...
static void OnGtbsServiceAddedCb(uint8_t status, int serverIf,
  ...
  for(int i=0; i< (int)service.size(); i++) {
    if (status == GATT_SUCCESS && cc_instance &&
        (service[i].type == BTGATT_DB_PRIMARY_SERVICE || service[i].type == BTGATT_DB_SECONDARY_SERVICE)) {
      cc_instance->added_services.push_back(service[i].attribute_handle);
      LOG(INFO) << __func__
    ...
    if (service[i].uuid == CALL_CONTROL_SERVER_UUID) {
      LOG(INFO) << __func__
                << ": GTBS service added attr handle: " << service[i].attribute_handle;
...
void PrintData(uint8_t data[], uint16_t len) {
  for (int i=0; i<len; i++) {
    LOG(INFO) << __func__ << ": data[" << i << "] = "
              << std::hex << std::setfill('0') << std::setw(2) << data[i] << std::endl;
  }
}
...
void HandleCcsEvent(uint32_t event, void* param) {
  ...
  switch (event) {
    ...
    case CCS_CLEANUP_EVENT: {
      ...
      for (const auto& handle : cc_instance->added_services) {
    ...
    case BTA_GATTS_CONNECT_EVT: {
      ...
      LOG(INFO) << __func__
                << ": remote devices connected conn_id: " << remoteDevice.conn_id
    ...
    case BTA_GATTS_READ_CHARACTERISTIC_EVT: {
      ...
      LOG(INFO) << __func__
                << ": charateristcs read handle " << p_data->req_data.p_data->read_req.handle
                << ", trans_id : " << p_data->req_data.trans_id;
      ...
      if (p_data->req_data.p_data->read_req.handle ==
        ...
        memcpy(rsp_struct.attr_value.value, &BearerProviderInfo.technology_type,
                                                          rsp_struct.attr_value.len);
        ...
        memcpy(rsp_struct.attr_value.value, &BearerProviderInfo.signal_report_interval,
                                                                 rsp_struct.attr_value.len);
        ...
        memcpy(rsp_struct.attr_value.value, BearerProviderInfo.bearer_schemes_list,
                                                           rsp_struct.attr_value.len);
        ...
        LOG(INFO) << __func__ << ": read request for unknow handle: "
                              << p_data->req_data.p_data->read_req.handle;
        status = BT_STATUS_FAIL;
        break;
      }
      LOG(INFO) << __func__ << ": read request handle: "
                            << p_data->req_data.p_data->read_req.handle
    ...
    case BTA_GATTS_READ_DESCRIPTOR_EVT: {
      ...
      LOG(INFO) << __func__ << ": charateristcs read desc handle: "
                            << p_data->req_data.p_data->read_req.handle
                            << ", offset : " << p_data->req_data.p_data->read_req.offset;
      ...
      if(p_data->req_data.p_data->read_req.handle ==
        ...
        LOG(INFO) << __func__ << ": read request for unknown handle: "
                              << p_data->req_data.p_data->read_req.handle;
        status = BT_STATUS_FAIL;
        break;
      }
    ...
    case BTA_GATTS_WRITE_DESCRIPTOR_EVT: {
      ...
      LOG(INFO) << __func__ << ": write descriptor : " << req.handle
                            << ", is resp: " << req.need_rsp
                            << ", is prep: " << req.is_prep
                            << ", value: " << req_value;

      if(req.handle == ccsControlServiceInfo.call_state_desc) {
      ...
      } else if(req.handle == ccsControlServiceInfo.bearer_provider_name_desc) {
      ...
      } else if(req.handle == ccsControlServiceInfo.call_control_point_desc) {
      ...
      } else if(req.handle == ccsControlServiceInfo.bearer_signal_strength_desc) {
      ...
      } else if(req.handle == ccsControlServiceInfo.bearer_uri_schemes_supported_desc) {
        remoteDevice->bearer_uri_schemes_supported_notify = req_value;
        write_desc_value.assign(BearerProviderInfo.bearer_schemes_list,
                                BearerProviderInfo.bearer_schemes_list +
                                strlen((char*)BearerProviderInfo.bearer_schemes_list));
        LOG(INFO) << __func__ << ": bearer_schemes_list Desc write";
        handle = ccsControlServiceInfo.bearer_uri_schemes_supported_handle;
      } else if(req.handle == ccsControlServiceInfo.bearer_list_currentcalls_desc) {
        std::map<uint8_t, tCCS_BEARER_LIST_CURRENT_CALLS>::iterator it;
      ...
      } else if(req.handle == ccsControlServiceInfo.bearer_technology_desc) {
        LOG(INFO) << __func__ << ": bearer_technology_desc write";
        LOG(INFO) << __func__ << ": bearer_technology_type: "
                              << BearerProviderInfo.technology_type;
      ...
      } else if(req.handle == ccsControlServiceInfo.call_friendly_name_desc) {
        LOG(INFO) << __func__ << ": call_friendly_name_desc read";
      ...
      } else if(req.handle == ccsControlServiceInfo.call_termination_reason_desc) {
        ...
        handle = ccsControlServiceInfo.call_termination_reason_handle;
      } else if(req.handle == ccsControlServiceInfo.call_status_flags_desc) {
    ...
    case CCS_ACTIVE_DEVICE_UPDATE: {
      ...
      if (cc_instance->remoteDevices.FindByAddress(data->address) != NULL) {
        ...
        LOG(ERROR) << __func__
           << ": CCS_ACTIVE_DEVICE_UPDATE: failed as given remote is not registered for notif: "
           << data->address;
      }
      break;
    }
    ...
    case CCS_BEARER_URI_SCHEMES_SUPPORTED: {
      ...
      LOG(INFO) << __func__ << ": CCS_BEARER_URI_SCHEMES_SUPPORTED: len: "
                            <<BearerProviderInfo.bearer_list_len;
      ReverseByteOrder(data->bearer_schemes_list, BearerProviderInfo.bearer_list_len);
      memcpy(BearerProviderInfo.bearer_schemes_list, data->bearer_schemes_list,
                                               BearerProviderInfo.bearer_list_len);
      rsp->event = CCS_NOTIFY_ALL;
    ...
    case CCS_STATUS_FLAGS_UPDATE: {
      ...
      _data.push_back(StatusFlags.supported_flags >> 0x08);
      isCallControllerOpUsed = true;
      break;
    }
  ...
  if(rsp->event != CCS_NONE_EVENT) {
    if (isCallControllerOpUsed == true) {
      rsp->oper.CallControllerOp.data = std::move(_data);
      LOG(INFO) << __func__ << ": After Moving size: "
                            << rsp->oper.CallControllerOp.data.size();
    }
 ...
 bool DeviceStateConnectionHandler(uint32_t event, void* param) {
  ...
  switch (event) {
    ...
    case CCS_DESCRIPTOR_WRITE_RSP: {
      LOG(INFO) << __func__ << ": device CCS_DESCRIPTOR_WRITE_RSP update rsp: "
      ...
      if (p_data->oper.WriteDescOp.need_rsp) {
        ...
        GattsOpsQueue::SendResponse(p_data->remoteDevice->conn_id,
                                    p_data->oper.WriteDescOp.trans_id,
      ...
      if (!p_data->oper.WriteDescOp.status && p_data->oper.WriteDescOp.notification) {
        ...
        LOG(INFO) << __func__ << ": notification disable  handle: "
                              << p_data->oper.WriteDescOp.char_handle;
      }
      break;
    }
    ...
    case CCS_DISCONNECTION: {
      ...
      GattsOpsQueue::Clean(p_data->remoteDevice->conn_id);
      cc_instance->ConnectionStateCallback(CCS_DISCONNECTED,
    ...
    case CCS_CONNECTION_CLOSE_EVENT: {
      ...
      if (p_data->remoteDevice->conn_id != 0) {
        ...
        BTA_GATTS_CancelOpen(ccsControlServiceInfo.server_if,
                             p_data->remoteDevice->peer_bda, true);
      }
      // Cancel pending background connections
      BTA_GATTS_CancelOpen(ccsControlServiceInfo.server_if,
                           p_data->remoteDevice->peer_bda, false);
      break;
    }
...
bool CCSActiveProfile(RawAddress addr) {
  ...
  LOG(INFO) << __func__ << ": activeProfile: " << activeProfile << ", for addr: " << addr;
...
bool CCSHandler(uint32_t event, void* param) {
  ...
  switch(p_data->event) {
    case CCS_NOTIFY_ALL: {
      ...
      std::vector<CallControllerDeviceList>notifyDevices =
                       cc_instance->remoteDevices.FindNotifyDevices(p_data->handle);
    ...
    case CCS_WRITE_RSP: {
      ...
      if (handle == ccsControlServiceInfo.call_control_point_handle) {
        ...
        if (gIsActiveCC == true &&
            !cc_instance->remoteDevices.FindActiveDevice(p_data->remoteDevice) &&
        ...
        switch(CallControllerOps.operation) {
          ...
          case CALL_ORIGINATE: {
            ...
            uint8_t Strm_state = 0;
            property_get("persist.vendor.btstack.tmap_CallState", Tmap_Call_State, "0");
            int res = sscanf(Tmap_Call_State, "%hu", &Strm_state);
            LOG(INFO) <<__func__ <<": res: " << res;
            LOG(INFO) <<__func__ <<": Strm_state: " << Strm_state;
            ...
            if (res == 1 && Strm_state == 2) {
               ...
               strlcpy(URI, OutgoingCallNumber, strlen(OutgoingCallNumber)+1);
            } else {
