/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
*  Copyright (c) 2013-2014, 2020, 2022-2024 Qualcomm Technologies, Inc.
*  All Rights Reserved.
...
public class GpsNetInitiatedHandler implements IzatService.ISystemEventListener {
    ...
    static public AtomicBoolean mIsInEmergency = new AtomicBoolean(false);
    ...
    public boolean readEmergencySUPLStatus() {
        Log.d(TAG, "public boolean readEmergencySUPLStatus():"
                + "mIsInEmergency is " + mIsInEmergency.get());
    ...
    public GpsNetInitiatedHandler(Context context, INetInitiatedListener netInitiatedListener) {
        ...
        mIZatServiceCtx.registerSystemEventListener(MSG_OUTGOING_CALL, this);
    ...
    public void notify(int msgId, Object... args) {
        if (msgId == MSG_OUTGOING_CALL) {
            Intent intent = (Intent)args[0];
            Log.d(TAG, "onReceive: " + msgId);
            ...
            if (mTelephonyMgr.isEmergencyNumber(phonenumber)) {
