...
@{ */
    ...
    public interface IZatWiFiDBReceiverResponseListener {
     ...
     public interface IZatWiFiDBReceiverResponseListenerExt {
          ...
          * @param ap_list List of APs.
          * @param location Location of area of interest.
          * @param isEmergency indicates whether the device is in emergency call.
          *
          * @return
          * None.
          */
         void onLookupRequest(List<IZatAPInfo> ap_list, Location location, boolean isEmergency);
          ...
          * None.
          */
         void onServiceRequest(boolean isEmergency);
     }
    /** @} */ /* end_addtogroup IZatWiFiDBReceiver */
...
@{ */
    ...
    public static class IZatAPLocationData {
        ...
        public enum IZatAltitudeReferenceType {
            UNKNOWN,
            ALT_REF_WGS84,
            ALT_REF_MSL,
            ALT_REF_AGL,
        ...
        public enum IZatApPositionQuality {
            UNKNOWN,
            VERY_LOW_ACCURACY,
            LOW_ACCURACY,
            HIGH_ACCURACY
        ...
        public enum IZatWiFiRttCapability {
            NOT_SUPPORTED,
            TWO_SIDED,
        }

        private IZatAltitudeReferenceType mAltRefType;
        private IZatApPositionQuality mPositionQuality;
        private IZatWiFiRttCapability mRttCapability;
        private float mAltitude;
        private float mRttRangeBiasInMm;

        private static final int IZAT_AP_LOC_MAR_VALID                = 0x1;
        private static final int IZAT_AP_LOC_HORIZONTAL_ERR_VALID     = 0x2;
        private static final int IZAT_AP_LOC_RELIABILITY_VALID        = 0x4;
        private static final int IZAT_AP_LOC_WITH_LAT_LON             = 0x8;
        private static final int IZAT_AP_LOC_ALT_VALID                = 0x10;
        private static final int IZAT_AP_LOC_POSITION_QUALITY_VALID    = 0x20;
        private static final int IZAT_AP_LOC_RTT_CAPABILITY_VALID     = 0x40;
        private static final int IZAT_AP_LOC_RTT_BIAS_VALID         = 0x80;
         ...
         * Sets the altitude.
         *
         * @param atitude atitude of the AP, unit is meter.
         * @param refType atitude reference type; see enum IZatAltitudeReferenceType
         *        {@link IZatAltitudeReferenceType}
         * @return
         * None.
         */
        public void setAltitude(float altitude, IZatAltitudeReferenceType refType) {
            mAltitude = altitude;
            mAltRefType = refType;
            mValidBits |= IZAT_AP_LOC_ALT_VALID;
        }

        /**
         * Sets the position quality.
         *
         * @param quality position quality of the AP; see enum IZatApPositionQuality
         *        {@link IZatApPositionQuality}
         * @return
         * None.
         */
        public void setApPositionQuality(IZatApPositionQuality quality) {
            mPositionQuality = quality;
            mValidBits |= IZAT_AP_LOC_POSITION_QUALITY_VALID;
        }

        /**
         * Sets the rtt capability.
         *
         * @param capability rtt capability of the AP; see enum IZatWiFiRttCapability
         *        {@link IZatWiFiRttCapability}
         * @return
         * None.
         */
        public void setRttCapability(IZatWiFiRttCapability capability) {
            mRttCapability = capability;
            mValidBits |= IZAT_AP_LOC_RTT_CAPABILITY_VALID;
        }

        /**
         * Sets the rtt range bias.
         *
         * @param bias rtt range bias of the AP, unit is milli-meter.
         *
         * @return
         * None.
         */
        public void setRttRangeBiasInMm(float bias) {
            mRttRangeBiasInMm = bias;
            mValidBits |= IZAT_AP_LOC_RTT_BIAS_VALID;
        }
        ...
        /**
         * Gets the RTT capability.
         *
         * @return
         * RTT capability type as IZatWiFiRttCapability{@link IZatWiFiRttCapability}
         */
        public IZatWiFiRttCapability getRttCapability() {
            if (0 == (IZAT_AP_LOC_RTT_CAPABILITY_VALID & mValidBits)) {
                throw new IZatStaleDataException("RTT capability is not valid");
            }
            return mRttCapability;
        }

        /**
         * Checks if RTT related parameters are valid or not.
         *
         * @return
         * Ture if all RTT related fields are valid, including RttRangeBiasInMm,
         * ApPositionQuality{@link ApPositionQuality}, Ap altitude.
         * False if all above fields are invalid.
         */
        public boolean isRttParametersValid() {
            return ((0 != (IZAT_AP_LOC_RTT_CAPABILITY_VALID & mValidBits)) &&
                    mRttCapability != IZatWiFiRttCapability.NOT_SUPPORTED);
        }

        /**
         * Gets the altitude in meter.
         *
         * @return
         * Altitude as a float value, unit is meter.
         */
        public float getAltitude() {
            if (0 == (IZAT_AP_LOC_ALT_VALID & mValidBits)) {
                throw new IZatStaleDataException("Altitude is not valid");
            }
            return mAltitude;
        }
         ...
         *
         * @return
         * Altitude reference type as IZatAltitudeReferenceType{@link IZatAltitudeReferenceType}
         */
        public IZatAltitudeReferenceType getAltitudeRefType() {
            if (0 == (IZAT_AP_LOC_ALT_VALID & mValidBits)) {
                throw new IZatStaleDataException("Altitude is not valid");
            }
            return mAltRefType;
        ...
        /**
         * Gets the ap position quality.
         *
         * @return
         * Ap position quality type as IZatApPositionQuality{@link IZatApPositionQuality}
         */
        public IZatApPositionQuality getApPositionQuality() {
            if (0 == (IZAT_AP_LOC_POSITION_QUALITY_VALID & mValidBits)) {
                throw new IZatStaleDataException("Position quality is not valid");
            }
            return mPositionQuality;
        }

        /**
         * Gets the rtt range bias in milli-meter.
         *
         * @return
         * Rtt range bias as a float value, unit is milli-meter.
         */
        public float getRttRangeBiasInMm() {
            if (0 == (IZAT_AP_LOC_RTT_BIAS_VALID & mValidBits)) {
                throw new IZatStaleDataException("RTT Bias is not valid");
            }
            return mRttRangeBiasInMm;
        }
    }
