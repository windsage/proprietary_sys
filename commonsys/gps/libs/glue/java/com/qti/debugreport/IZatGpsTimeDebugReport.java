...
@{ */
    ...
    */
    ...
    public IZatGpsTimeDebugReport(IZatUtcSpec utcTimeLastUpdated,
        ...
        int clockfrequencyBiasUncertainity, int leapSeconds, int leapSecUnc) {
    ...
    public IZatGpsTimeDebugReport(Parcel source) {
        ...
        mLeapSeconds = source.readInt();
        mLeapSecUnc = source.readInt();
    }
   ...
   */
    ...
    */
    ...
    /**
    * Gets the leap second uncertainity.
    *
    * @return gets the leap second uncertainity.
    */
    public int getLeapSecUnc() {
        return mLeapSecUnc;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(mLeapSeconds);
        dest.writeInt(mLeapSecUnc);
    }
