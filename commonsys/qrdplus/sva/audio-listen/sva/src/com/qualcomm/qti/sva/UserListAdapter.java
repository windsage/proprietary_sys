...
public class UserListAdapter extends BaseAdapter {
    ...
    public UserListAdapter(Context context, ArrayList<IUserModel> listData,
                           OnListenerCallback callback, ModelVersion version) {
        mContext = context;
        mListData = listData;
        mCallback = callback;
        mVersion = version;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (null == view) {
            ...
            View deleteUserView = view.findViewById(R.id.iv_delete_user);
            rowViewHolder.mLayoutUserItem = view.findViewById(R.id.layout_user_item);
            rowViewHolder.mLayoutUserItem.setTag(rowViewHolder);
            LogUtils.d(TAG, "modle version " + mVersion.getLable());
            if (mVersion.getVersionNumber() < ModelVersion.VERSION_3_0.getVersionNumber()) {
                ...
                rowViewHolder.mLayoutUserItem.setEnabled(false);
                rowViewHolder.mLayoutUserItem.setClickable(false);
