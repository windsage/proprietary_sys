...
public class SmModel implements ISmModel {
    ...
    private int mSmType;
    private ModelVersion mSmVersion = ModelVersion.VERSION_2_0;
    ...
    @Override
    public ModelVersion getSoundModelVersion() {
        return mSmVersion;
    }

    @Override
    public void setSoundModelVersion(ModelVersion version) {
        mSmVersion = version;
    }
    ...
    public boolean canAddUser() {
        ...
        if (!isUserTrainedSoundModel() || isUdkSm()) {
            ...
            // for pdk UV model
            if (mSmVersion == ModelVersion.VERSION_3_0
                || mSmVersion == ModelVersion.VERSION_4_0
                || mSmVersion == ModelVersion.VERSION_5_0
                || mSmVersion == ModelVersion.VERSION_6_0
                || mSmVersion == ModelVersion.VERSION_7_0
                || mSmVersion == ModelVersion.VERSION_8_0
                || mSmVersion == ModelVersion.VERSION_9_0) {
    ...
    @Override
    public boolean isSupportExtendedOpaqueData() {
        return (mSmVersion.getVersionNumber() >= ModelVersion.VERSION_3_0.getVersionNumber());
    }
}
