...
public class Msg {
    ...
    //query sound model file
    public static final int MSG_QUERY_SOUND_MODEL_DONE = 0x1103;

    //voice request cancel message
    public static final int MSG_ENABLED_ON_OFF = 0x1104;
