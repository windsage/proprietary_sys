...
public class KeyphraseSettingsActivity extends Activity
    ...
    private RelativeLayout mExtendedTraining;
    private View mSeparatorUnderExtendedTraining;
    ...
    private void updateUI() {
        ...
        updateExtendedTrainingVisibility();
    }
    ...
    private void initializeUI() {
        ...
        mListData = extendedSmModel.getAllUsers();
        ModelVersion modleVersion = extendedSmModel.getSoundModelVersion();
        UserListAdapter adapter = new UserListAdapter(this, mListData, this, modleVersion);
        ...
        mExtendedTraining = findViewById(R.id.layout_extended_training);
        mExtendedTraining.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                LogUtils.d(TAG, "onClick: supplement training");
                if (mListData.size() >= 1) {
                    startTrainingActivity(mSmName, mExtendedSmModel.getSoundModelPrettyKeyphrase(),
                            mListData.get(0).getUserName(), false,
                            SMLParametersManager.RECORDING_IN_NOISY_ENVIRONMENT);
                }
            }
        });
        mSeparatorUnderExtendedTraining = findViewById(R.id.separator_under_extended_training);
    ...
    private void updateExtendedTrainingVisibility() {
        if (mIsUdkSm || !mIsTrainedModel || mListData.size() < 1
                || !Utils.isSupportImprovedTraining()) {
            mExtendedTraining.setVisibility(View.GONE);
            mSeparatorUnderExtendedTraining.setVisibility(View.GONE);
        } else {
            mExtendedTraining.setVisibility(View.VISIBLE);
            mSeparatorUnderExtendedTraining.setVisibility(View.VISIBLE);
        }
    }
    ...
    private void startTrainingActivity(String previousSmName, String keyphrase,
                                       String userName, boolean addUserToPreviousModel,
                                       int recordingType) {
        ...
        intent.putExtra(TrainingActivity.KEY_EXTRA_IS_ADD_USER_TO_PREVIOUS_MODEL,
                addUserToPreviousModel);
        intent.putExtra(TrainingActivity.KEY_RECORDING_TYPE, recordingType);
        startActivity(intent);
    }
        ...
        builder.setView(view)
                ...
                .setPositiveButton(R.string.train, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        startTrainingActivity(previousSmName, keyphrase, userName, true,
    ...
    private class DeleteUserTask extends AsyncTask<String, Void, Integer> {
        ...
        protected Integer doInBackground(String... strings) {
            ...
            String recordingsPath = Global.PATH_TRAINING_RECORDINGS + "/"
                    + mUserName + "/" + mSmName;
            if (mIsUdkSm) {
                ...
                //delete user training recordings
                FileUtils.deleteFile(recordingsPath);
    ...
    private class DeleteKeyphraseTask extends AsyncTask<String, Void, Integer> {
        ...
        protected Integer doInBackground(String... strings) {
            ...
            //delete user training recordings
            for (IUserModel userModel: mListData) {
                String recordingsPath = Global.PATH_TRAINING_RECORDINGS + "/"
                        + userModel.getUserName() + "/" + mSmName;
                FileUtils.deleteFile(recordingsPath);
            }
