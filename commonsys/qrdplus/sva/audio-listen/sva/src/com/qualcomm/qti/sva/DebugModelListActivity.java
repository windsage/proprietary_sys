                ...
                .setPositiveButton(R.string.delete, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int which) {
                        ...
                        for (String item : mCheckedSmNameList) {
                            ...
                            if(item.equalsIgnoreCase(mSelectedSmFullName)){
                                LogUtils.d(TAG, "ShowDeleteModelDialog: " +
                                        "delete model is the selected model in activity");
                                mSelectedSmFullName =  null;
                            }
                            String name =
                                    ((ModelListAdapter) mListView.getAdapter()).getCheckedSmName();
                            if(name != null && item.equalsIgnoreCase(name)){
                                LogUtils.d(TAG, "ShowDeleteModelDialog: " +
                                        "delete model is the selected model in adapter");
                                ((ModelListAdapter) mListView.getAdapter()).setCheckedSmName(null);
                            }
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if (isUdk) {
                            ISmModel.ModelVersion version =
                                    Utils.getUdkVersion(DebugModelListActivity.this, smName);
