...
public class KeyphraseListAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        ISmModel.ModelVersion version = rowViewHolder.mItemData.getSoundModelVersion();
        settings += " " + mContext.getString(R.string.model) + version.getLable();
        ...
        checked |= rowViewHolder.mItemData.getSessionStatus()
                == IExtendedSmModel.SessionStatus.PENDINGSTARTED;
        if (rowViewHolder.mItemData.getSessionStatus()
                == IExtendedSmModel.SessionStatus.PENDINGSTARTED) {
            LogUtils.d(TAG, "change status from PENDING STARTED to UNLOADED");
            rowViewHolder.mItemData.setSessionStatus(IExtendedSmModel.SessionStatus.UNLOADED);
        }
