...
public class ExtendedSmModel extends SmModel implements IExtendedSmModel {
    ...
    private boolean mLABRecording = false;
    ...
    @Override
    public boolean getLABRecordingStatus() {
        LogUtils.d(TAG, "getLABRecordingStatus: mLABRecording = " + mLABRecording);
        return mLABRecording;
    }

    @Override
    public void setLABRecordingStatus(boolean islabrecording) {
        LogUtils.d(TAG, "setLABRecordingStatus: islabrecording = " + islabrecording);
        mLABRecording = islabrecording;
    }
