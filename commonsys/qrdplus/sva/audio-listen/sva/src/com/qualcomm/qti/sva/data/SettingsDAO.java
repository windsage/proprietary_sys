...
final class SettingsDAO {
    ...
    private static final String KEY_GLOBAL_TRAINING_PATH
            = "global_training_path";
    private static final String KEY_GLOBAL_UDK4_BASE_MODEL
            = "global_udk4_base_model";
    private static final String KEY_GLOBAL_UDK7_BASE_MODEL
            = "global_udk7_base_model";
    ...
    private static final String KEY_MULTIKWTHRESHOLD_ENABLED
            = "multi_kw_threshold_enabled";
    private static final String KEY_MULTI_FIRST_KW_CONFIDENCELEVEL
            = "multi_first_kw_confidencelevel";
    ...
    private static final String KEY_BASE_SOUND_MODEL = "base_sound_model";
    private static final String KEY_PDK_ENROLLMENT_TIMES = "pdk_enrollment_times";
    ...
    private static final int DEFAULT_GLOBAL_TRAINING_PATH
            = MediaRecorder.AudioSource.VOICE_RECOGNITION;
    private static final String DEFAULT_GLOBAL_UDK4_BASE_MODEL
            = "merged_language_model.lat";
    private static final String DEFAULT_GLOBAL_UDK7_BASE_MODEL
            = "sm7_chinese_language_model_gmm_udk7_vop2.lat";
    ...
    private static final boolean DEFAULT_MULTI_KW_THRESHOLD_ENABLED = false;
    private static final String DEFAULT_MULTI_FIRST_KW_CONFIDENCELEVEL
            = "40#40#40#40#40";
    ...
    static void setGlobal1stKeyphraseConfidenceLevel(SharedPreferences sharedPrefs, 
                                                    ISmModel.ModelVersion version,int level) {
    ...
    static int getGlobalTrainingPath(SharedPreferences sharedPrefs) {
        if (null == sharedPrefs) {
            LogUtils.d(TAG, "getGlobalTrainingPath: invalid param");
            return DEFAULT_GLOBAL_TRAINING_PATH;
        }

        return sharedPrefs.getInt(KEY_GLOBAL_TRAINING_PATH,
                DEFAULT_GLOBAL_TRAINING_PATH);
    }

    static void setGlobalTrainingPath(SharedPreferences sharedPrefs, int level) {
        if (null == sharedPrefs) {
            LogUtils.d(TAG, "setGlobalTrainingPath: invalid param");
            return;
        }
        sharedPrefs.edit().putInt(KEY_GLOBAL_TRAINING_PATH, level).apply();
    }

    static String getUDK4BaseSoundModel(SharedPreferences sharedPrefs) {
        if (null == sharedPrefs) {
            LogUtils.d(TAG, "getUDK4BaseSoundModel: invalid param");
            return DEFAULT_GLOBAL_UDK4_BASE_MODEL;
        }

        return sharedPrefs.getString(KEY_GLOBAL_UDK4_BASE_MODEL,
                DEFAULT_GLOBAL_UDK4_BASE_MODEL);
    }

    public static void setUDK4BaseSoundModel(SharedPreferences sharedPrefs, String baseSoundModel) {
        LogUtils.d(TAG, "setUDK4BaseSoundModel: baseSoundModel = " + baseSoundModel);
        if (null == sharedPrefs || null == baseSoundModel) {
            LogUtils.d(TAG, "setUDK4BaseSoundModel: invalid param");
            return;
        }

        sharedPrefs.edit().putString(KEY_GLOBAL_UDK4_BASE_MODEL, baseSoundModel).apply();
    }

    static String getUDK7BaseSoundModel(SharedPreferences sharedPrefs) {
        if (null == sharedPrefs) {
            LogUtils.d(TAG, "getUDK7BaseSoundModel: invalid param");
            return DEFAULT_GLOBAL_UDK7_BASE_MODEL;
        }

        return sharedPrefs.getString(KEY_GLOBAL_UDK7_BASE_MODEL,
                DEFAULT_GLOBAL_UDK7_BASE_MODEL);
    }

    public static void setUDK7BaseSoundModel(SharedPreferences sharedPrefs, String baseSoundModel) {
        LogUtils.d(TAG, "setUDK7BaseSoundModel: baseSoundModel = " + baseSoundModel);
        if (null == sharedPrefs || null == baseSoundModel) {
            LogUtils.d(TAG, "setUDK7BaseSoundModel: invalid param");
            return;
        }

        sharedPrefs.edit().putString(KEY_GLOBAL_UDK7_BASE_MODEL, baseSoundModel).apply();
    }
    ...
    static boolean getMultiKWThresholdEnabled(SharedPreferences sharedPrefs) {
        if (null == sharedPrefs) {
            LogUtils.d(TAG, "getMultiKWThresholdEnabled: invalid param");
            return DEFAULT_MULTI_KW_THRESHOLD_ENABLED;
        }

        return sharedPrefs.getBoolean(KEY_MULTIKWTHRESHOLD_ENABLED,
                DEFAULT_MULTI_KW_THRESHOLD_ENABLED);
    }

    static void setMultiKWThresholdEnabled(SharedPreferences sharedPrefs, boolean enabled) {
        if (null == sharedPrefs) {
            LogUtils.d(TAG, "setMultiKWThresholdEnabled: invalid param");
            return;
        }

        sharedPrefs.edit().putBoolean(KEY_MULTIKWTHRESHOLD_ENABLED, enabled).apply();
    }

    public static void setMultiFirstKWConfidenceLevel(SharedPreferences sharedPrefs,
                                                        String confidencelevel) {
        LogUtils.d(TAG, "setMultiFirstKWConfidenceLevel:confidencelevel="+confidencelevel);
        if (null == sharedPrefs || null == confidencelevel) {
            LogUtils.d(TAG, "setMultiFirstKWConfidenceLevel: invalid param");
            return;
        }

        sharedPrefs.edit().putString(KEY_MULTI_FIRST_KW_CONFIDENCELEVEL, confidencelevel).apply();
    }

    public static String getMultiFirstKWConfidenceLevel(SharedPreferences sharedPrefs) {
        if (null == sharedPrefs) {
            LogUtils.d(TAG, "getMultiFirstKWConfidenceLevel: invalid param");
            return DEFAULT_MULTI_FIRST_KW_CONFIDENCELEVEL;
        }

        return sharedPrefs.getString(KEY_MULTI_FIRST_KW_CONFIDENCELEVEL,
                                        DEFAULT_MULTI_FIRST_KW_CONFIDENCELEVEL);
    }
    ...
    public static void setBaseSoundModel(SharedPreferences sharedPrefs, String baseSoundModel) {
        LogUtils.d(TAG, "setBaseSoundModel: baseSoundModel = " + baseSoundModel);
        if (null == sharedPrefs || null == baseSoundModel) {
            LogUtils.d(TAG, "setBaseSoundModel: invalid param");
            return;
        }

        sharedPrefs.edit().putString(KEY_BASE_SOUND_MODEL, baseSoundModel).apply();
    }

    public static String getBaseSoundModel(SharedPreferences sharedPrefs) {
        if (null == sharedPrefs) {
            LogUtils.d(TAG, "getBaseSoundModel: invalid param");
            return "";
        }

        return sharedPrefs.getString(KEY_BASE_SOUND_MODEL, "");
    }
    ...
    private static int getDefaultGlobalConfidenceLevel(int type,
        ...
        switch(type) {
            case TYPE_1ST_KEYPHRASE:
                if (version == ModelVersion.VERSION_2_0) {
                    confidenceLevel = DEFAULT_GLOBAL_SM2_1ST_KEYPHRASE_CONFIDENCE_LEVEL;
                } else if(version == ModelVersion.VERSION_3_0
                            || version == ModelVersion.VERSION_4_0
                            || version == ModelVersion.VERSION_5_0
                            || version == ModelVersion.VERSION_6_0
                            || version == ModelVersion.VERSION_7_0
                            || version == ModelVersion.VERSION_8_0
                            || version == ModelVersion.VERSION_9_0) {
    ...
    private static String getGlobalKey(int type, ISmModel.ModelVersion version) {
    ...
    public static int getPDKEnrollmentRecordingTimes(SharedPreferences sharedPrefs) {
        if (null == sharedPrefs) {
            LogUtils.d(TAG, "getPDKEnrollmentRecordingTimes: invalid param");
            return 5;
        }
        return sharedPrefs.getInt(KEY_PDK_ENROLLMENT_TIMES, 5);
    }


    public static void setPDKEnrollmentRecordingTimes(int recordingTimes, SharedPreferences sharedPrefs) {
        if (null == sharedPrefs) {
            LogUtils.d(TAG, "setPDKEnrollmentRecordingTimes: invalid param");
            return;
        }
        sharedPrefs.edit().putInt(KEY_PDK_ENROLLMENT_TIMES, recordingTimes).apply();
    }
}
