...
public class Global {
    ...
    public final static String SVA_EPD_ENABLED = "sva_epd_enabled";
    ...
    public final static String NAME_SECOND_STAGE_RECORD_SUBDIR = "secondStageRecord";
    public final static String SUFFIX_WAV_FILE = ".wav";
    public static final String RECORDING_TYPE_CLEAN = "clean";
    public static final String RECORDING_TYPE_NOISY = "noisy";
    ...
    public final static String NAME_SM7_MERGED_LANGUAGE_MODEL =
                                                "sm7_chinese_language_model_gmm_udk7_vop2.lat";
    public final static String NAME_SML_CONFIGURATIONS = "sml_config.xml";
    ...
    public static String PATH_SECOND_STAGE_RECORD = null;
    ...
    private Global(Context context) {
        ...
        PATH_SECOND_STAGE_RECORD = PATH_ROOT + "/"
            + NAME_SECOND_STAGE_RECORD_SUBDIR;
    ...
    public static boolean isSvaEpdEnabled(Context context) {
        return Settings.Global.getInt(context.getContentResolver(),
                SVA_EPD_ENABLED, 0) != 0;
    }
