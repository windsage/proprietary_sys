...
public class SimUpdateMonitor {
    ...
    private SimUpdateMonitor(Context context) {
        ...
        context.registerReceiver(mSimStateReceiver, intentFilter, Context.RECEIVER_EXPORTED);
    }
    ...
    private void handleSimStateChange(Intent intent) {
        ...
        if (data.mState == SIM_STATE_ERROR
                || !SubscriptionManager.isValidSubscriptionId(data.mSubscriptionId)) {
