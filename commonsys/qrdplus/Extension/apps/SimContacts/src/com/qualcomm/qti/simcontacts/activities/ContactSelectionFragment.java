...
public class ContactSelectionFragment extends ListFragment
        ...
        View.OnClickListener, SimUpdateMonitor.SimStateListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        SimUpdateMonitor.getInstance(mContext.getApplicationContext()).
    ...
    public void onSimStateChanged(int subscriptionId, int state) {
        if (state == SimUpdateMonitor.SIM_STATE_ERROR) {
            final SubscriptionManager sm = mActivity.getSystemService(SubscriptionManager.class);
            if (sm != null && !sm.isActiveSubscriptionId(mSubscriptionId)) {
                getActivity().finish();
            }
        }
    }
