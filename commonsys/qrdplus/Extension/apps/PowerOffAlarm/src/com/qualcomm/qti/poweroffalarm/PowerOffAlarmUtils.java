...
public class PowerOffAlarmUtils {
    ...
    public static long setAlarmToRtc(long alarmTime) {
        ...
        try {
            IAlarmBaseAdapter adapter = AlarmAdapterManager.getAlarmAdapter();
            int ret = adapter.setAlarm(alarmTimeToRtc);
