...
public class AlarmV1_0Adapter implements IAlarmBaseAdapter {
    private vendor.qti.hardware.alarm.V1_0.IAlarm mProxy;
    public AlarmV1_0Adapter(vendor.qti.hardware.alarm.V1_0.IAlarm proxy) {
        mProxy = proxy;
    }
