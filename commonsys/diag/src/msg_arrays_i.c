...
Copyright (c) 2010-2021, 2023-2024 Qualcomm Technologies, Inc.
All Rights Reserved.
...
static const uint32 msg_bld_masks_gen[] =
{
  ...
  MSG_BUILD_MASK_MSG_SSID_QWES,
  MSG_BUILD_MASK_MSG_SSID_ONDEVICE_HLOS,
  MSG_BUILD_MASK_MSG_SSID_AWARE_LOCATION,
  MSG_BUILD_MASK_MSG_SSID_AWARE_BOOTUP,
  MSG_BUILD_MASK_MSG_SSID_AWARE_CONFIG,
  MSG_BUILD_MASK_MSG_SSID_AWARE_DATA,
  MSG_BUILD_MASK_MSG_SSID_AWARE_SENSOR,
  MSG_BUILD_MASK_MSG_SSID_MGPME_MC,
...
static const uint32 msg_bld_masks_wear_aon[] =
{
   MSG_BUILD_MASK_MSG_SSID_WEAR_AON_SNS_PLATFORM,
   MSG_BUILD_MASK_MSG_SSID_WEAR_AON_SNS_SENSOR_INT,
   MSG_BUILD_MASK_MSG_SSID_WEAR_AON_SNS_FRAMEWORK,
   MSG_BUILD_MASK_MSG_SSID_WEAR_AON_SNS_SENSOR_EXT,
   MSG_BUILD_MASK_MSG_SSID_WEAR_AON_SNS,
   MSG_BUILD_MASK_MSG_SSID_WEAR_AON_COREBSP_COAPP,
   MSG_BUILD_MASK_MSG_SSID_WEAR_AON_Display_SM,
   MSG_BUILD_MASK_MSG_SSID_WEAR_AON_Display_RM,
   MSG_BUILD_MASK_MSG_SSID_WEAR_AON_Display_Driver,
   MSG_BUILD_MASK_MSG_SSID_WEAR_AON_Display_Platform,
   MSG_BUILD_MASK_MSG_SSID_WEAR_AON_Display_GPU_Driver,
   MSG_BUILD_MASK_MSG_SSID_WEAR_AON_CONN_MGR,
   MSG_BUILD_MASK_MSG_SSID_WEAR_AON_WEAR_MGR,
   MSG_BUILD_MASK_MSG_SSID_WEAR_AON_ML_APPS,
   MSG_BUILD_MASK_MSG_SSID_WEAR_AON_LOG_PROXY,
   MSG_BUILD_MASK_MSG_SSID_WEAR_AON_POWER_DB,
   MSG_BUILD_MASK_MSG_SSID_WEAR_AON_REF_APP,
   MSG_BUILD_MASK_MSG_SSID_WEAR_AON_AUDIOMANAGER,
   MSG_BUILD_MASK_MSG_SSID_WEAR_AON_PMIC,
   MSG_BUILD_MASK_MSG_SSID_WEAR_AON_COREBSP_AUDIO,
   MSG_BUILD_MASK_MSG_SSID_WEAR_AON_AUDIOSS,
};

static uint32 msg_rt_masks_wear_aon[2][sizeof(msg_bld_masks_wear_aon) /
  sizeof(msg_bld_masks_wear_aon[0])];

static const uint32 msg_bld_masks_fw_csm[] =
{
  MSG_BUILD_MASK_MSG_SSID_FW_CSM_CPLANE_CMN,
  MSG_BUILD_MASK_MSG_SSID_FW_CSM_CPLANE_CFG,
  MSG_BUILD_MASK_MSG_SSID_FW_CSM_CPLANE_DL,
  MSG_BUILD_MASK_MSG_SSID_FW_CSM_CPLANE_UL,
  MSG_BUILD_MASK_MSG_SSID_FW_CSM_L1API_CMN,
  MSG_BUILD_MASK_MSG_SSID_FW_CSM_L1API_CFG,
  MSG_BUILD_MASK_MSG_SSID_FW_CSM_L1API_WP,
  MSG_BUILD_MASK_MSG_SSID_FW_CSM_L1API_RPT,
  MSG_BUILD_MASK_MSG_SSID_FW_CSM_L1API_UT,
  MSG_BUILD_MASK_MSG_SSID_FW_CSM_FAPI_CMN,
  MSG_BUILD_MASK_MSG_SSID_FW_CSM_QDU_Q6_MVT,
  MSG_BUILD_MASK_MSG_SSID_FW_CSM_IMPS_CMN,
  MSG_BUILD_MASK_MSG_SSID_FW_CSM_IMPS_ADAPTER_CMN,
  MSG_BUILD_MASK_MSG_SSID_FW_CSM_MPLANE_CMN,
  MSG_BUILD_MASK_MSG_SSID_FW_CSM_RUMGR,
  MSG_BUILD_MASK_MSG_SSID_FW_CSM_TIMETRIG,
  MSG_BUILD_MASK_MSG_SSID_FW_CSM_AXIDMA_CMN,
  MSG_BUILD_MASK_MSG_SSID_FW_CSM_MCXDMA_CMN,
  MSG_BUILD_MASK_MSG_SSID_FW_CSM_DMAMEMCPY_CMN,
  MSG_BUILD_MASK_MSG_SSID_FW_CSM_DANIPC_CMN,
  MSG_BUILD_MASK_MSG_SSID_FW_CSM_ORAN,
  MSG_BUILD_MASK_MSG_SSID_CSM_DU_FAPI,
  MSG_BUILD_MASK_MSG_SSID_CSM_DU_L1API,
  MSG_BUILD_MASK_MSG_SSID_CSM_DU_CPLANE,
  MSG_BUILD_MASK_MSG_SSID_CSM_DU_MPLANE,
  MSG_BUILD_MASK_MSG_SSID_CSM_DU_IMPS,
  MSG_BUILD_MASK_MSG_SSID_CSM_DU_TIMETRIG,
  MSG_BUILD_MASK_MSG_SSID_CSM_DU_RUMGR,
  MSG_BUILD_MASK_MSG_SSID_CSM_DU_ORAN,
  MSG_BUILD_MASK_MSG_SSID_CSM_DU_AXIDMA,
  MSG_BUILD_MASK_MSG_SSID_CSM_DU_MCXDMA,
  MSG_BUILD_MASK_MSG_SSID_CSM_DU_DMAMEMCPY,
  MSG_BUILD_MASK_MSG_SSID_CSM_DU_DANIPC,
  MSG_BUILD_MASK_MSG_SSID_FW_CSM_TENX,
  MSG_BUILD_MASK_MSG_SSID_FW_CSM_SP,
  MSG_BUILD_MASK_MSG_SSID_FW_CSM_SYSLOG,
  MSG_BUILD_MASK_MSG_SSID_CSM_DU_DIAG_LOG,
};

static uint32 msg_rt_masks_fw_csm[2][sizeof(msg_bld_masks_fw_csm) /
  sizeof(msg_bld_masks_fw_csm[0])];

static const uint32 msg_bld_masks_csm_oran[] =
{
 MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_SPLANE,
 MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_SPLANE_PTP,
 MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_SPLANE_SYNCE,
 MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_SPLANE_OSAL,
 MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_SPLANE_TEST,
 MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_MPLANE_RU_RU,
 MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_MPLANE_RU_SRP,
 MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_MPLANE_RU_NP,
 MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_MPLANE_RU_YMI,
 MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_MPLANE_DU_NCB,
 MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_MPLANE_DU_AP,
 MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_MPLANE_DU_OAM,
 MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_MPLANE_DUMAN_SIM,
 MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_MPLANE_MACE_SIM,
 MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_MPLANE_QNET_SIM,
 MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_MPLANE_RUMAN_SIM,
 MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_MPLANE_SPLANE_SIM,
 MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_MPLANE_RU_OEM,
 MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_SPLANE_ACCUTIME,
 MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_SPLANE_GPS_UTILITY,
 MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_TRANSCEIVER,
 MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_FMGR_GENERIC,
 MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_FMGR_PERIODIC,
 MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_PWRMGR_GENERIC,
 MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_EPE_GENERIC,
};

static uint32 msg_rt_masks_csm_oran[2][sizeof(msg_bld_masks_csm_oran) /
  sizeof(msg_bld_masks_csm_oran[0])];
...
(uint32*)msg_rt_masks_dpm
    ...
    ,
  {
    ...
    ,
  {
    MSG_SSID_WEAR_AON_SNS_FRAMEWORK,
    /* FIRST + array count */
    MSG_SSID_WEAR_AON_SNS_FRAMEWORK+
       sizeof (msg_bld_masks_wear_aon) / sizeof(msg_bld_masks_wear_aon[0]) - 1,
    msg_bld_masks_wear_aon,
    (uint32*)msg_rt_masks_wear_aon
  }
    ,
  {
    MSG_SSID_FW_CSM_CPLANE_CMN,
    /* FIRST + array count */
    MSG_SSID_FW_CSM_CPLANE_CMN+
       sizeof(msg_bld_masks_fw_csm) / sizeof(msg_bld_masks_fw_csm[0]) - 1,
    msg_bld_masks_fw_csm,
    (uint32*)msg_rt_masks_fw_csm
   }
    ,
   {
    MSG_SSID_CSM_ORAN_SPLANE,
    /* FIRST + array count */
    MSG_SSID_CSM_ORAN_SPLANE+
       sizeof(msg_bld_masks_csm_oran) / sizeof(msg_bld_masks_csm_oran[0]) - 1,
    msg_bld_masks_csm_oran,
    (uint32*)msg_rt_masks_csm_oran
   }
};
