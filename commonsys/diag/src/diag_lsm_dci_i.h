...
#endif
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
# Copyright (c) 2014, 2016, 2018-2023, Qualcomm Technologies, Inc.
# All Rights Reserved.
...
struct diag_dci_client_tbl {
	...
	struct diag_dci_periph_buffering_tx_mode dci_tx_mode_params;
	void (*func_ptr_dci_buffering_status)(int  data);
};
