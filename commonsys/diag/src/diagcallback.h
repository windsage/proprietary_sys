...
#include <aidl/vendor/qti/diaghal/BnIdiagcallback.h>
...
class Idiagcallback : public BnIdiagcallback {
public:
	ScopedAStatus send_data(const ParcelableMemory& in_mem, int32_t in_len, int32_t* _aidl_return);
};
