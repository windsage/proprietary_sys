...
public class WifiP2pNetDevice implements NetDeviceIF {
    ...
    static class WifiP2pWfdInfoHelper {
        ...
        static {
            ...
            try {
                method_isWfdR2Supported = WifiP2pWfdInfo.class.getMethod("isR2Supported");
            } catch (Exception e) {
                Log.e(TAG, "Failed to get WifiP2pWfdInfo.isR2Supported() method", e);
            }
            ...
            try {
                method_setWfdR2Device = WifiP2pWfdInfo.class.getMethod("setR2DeviceType", int.class);
            } catch (Exception e) {
                Log.e(TAG, "Failed to get WifiP2pWfdInfo.setR2DeviceType(int) method", e);
            }
