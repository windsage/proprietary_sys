...
*
*
*  Copyright (c) 2011-2019, 2022 Qualcomm Technologies, Inc.
*  All Rights Reserved.
...
typedef struct
{
  std::string   xor_support;
  unsigned int  x_max;
  unsigned int  y_max;
  unsigned int  cursor_port;
}WFD_HWcursor_info_type;
...
typedef struct {
    ...
    WFD_HWcursor_info_type          hw_cursor;
...
typedef enum {
    ...
    WFD_STATUS_SOURCE_STATS_UPDATE,
    WFD_STATUS_INVALID,
} WFD_status_t;
