               ...
               SecureCaptureFragment.OnFragmentInteractionListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        stopBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                //delete Session
                Log.d(getLogTag(), "Deleting Session");
    ...
    public void onStop()
    {
        ...
        if(mSecureProcessorProxy != null) {
            Log.d(getLogTag(), "onStop stopping session");
            if (mSecureProcessorProxy.getSessionId() > 0) {
    ...
    {
        super.onBackPressed();
        Log.d(getLogTag(),"Back Button Pressed, deleting session and moving back to MainActivity");
        if(mSecureProcessorProxy != null)
        {
            mSecureProcessorProxy.deleteSession();
            mSecureProcessorProxy = null;
