...
import com.qualcomm.qti.cam2test.callbackinterface;
...
public class MainActivity extends AppCompatActivity implements callbackinterface.StatusCallback
{
    private static final int REQUEST_CAMERA_PERMISSION = 0;
    static final int numSupportedCameras = 2;
    private boolean isSessionStarted_ = false;
    private callbackinterface mCbObj = null;
    ...
    public static String DEFAULT_DEST = "qti-tee";
    ...
    public static Boolean DCPSwitchState = false;

    //Custom flag for FR97622
    public static int SCALER_AVAILABLE_STREAM_USE_CASES_SECURE_MODE = 65539;

    protected Switch FDSwitch;
    protected Switch DCPSwitch;
    ...
    @Override protected void onCreate(Bundle savedInstanceState)
    {
        ...
        DCPSwitch = (Switch)findViewById(R.id.DCPSwitch);
        ...
        // get destination from preference xml
        DEFAULT_DEST = sharedPreferences.getString(
            this.getString(R.string.key_select_destination_1), "qti-tee");

        mIntent = new Intent(MainActivity.this, servicestatus.class);
        startService(mIntent);
        mCbObj = new callbackinterface();
        mCbObj.enableCallback(MainActivity.this);
    }
        ...
        new SharedPreferences.OnSharedPreferenceChangeListener() {
                                                  ...
                                                  String key)
            {
                ...
                if (key.contains("destination")) {  // If destination changed,
                                                    ...
                                                    // and session
                    DEFAULT_DEST = prefs.getString(key, null);
                    Log.d(getLogTag(), "New Destination "+ DEFAULT_DEST);
                }
            }
        };
    ...
    View.OnClickListener startListener = new View.OnClickListener() {
        ...
        public void onClick(View v)
        {
            ...
            DCPSwitchState = DCPSwitch.isChecked();

            // Create a SecureProcessor object with default destination
            Log.d(getLogTag(), "Creating Session");
            mSecureProcessorProxy = new MediaSecureProcessorProxy();
            int ret = mSecureProcessorProxy.createSession(DEFAULT_DEST);
            if (ret != 0) {
                alertAndClose(
                    "Unable to create MediaSecureProcessor. push correct TA or provide correct destination.",
                    true);
                return;
            }
    ...
    public void finishSession() {
        finish(); //To make sure the onDestroy is invoked
    }
