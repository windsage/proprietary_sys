...
public class SecureCaptureFragment extends Capture
{
    ...
    boolean isMultiStreamSelected()
    {
        ...
        if (count > 1) {
            Log.d(getLogTag(), "Multi stream usecase selected");
            multiStream = true;
        }
    ...
    private final ImageReader
        ...
        new ImageReader.OnImageAvailableListener() {
            ...
            @Override public void onImageAvailable(ImageReader reader)
            {
                ...
                ret = frameConfig.addEntry(frameConfig.IMAGE_CONFIG_FRAME_NUMBER,
                                           tmpNumFrames, 1);
    ...
    @Override protected int resetSecureCamera()
    {
        ...
        if (!isSecurePreviewSelected() && !isMultiStreamSelected()) {
