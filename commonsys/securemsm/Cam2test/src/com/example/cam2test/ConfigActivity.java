                ...
                for(String camId: camManager.getCameraIdList()) {
                 ...
                 /*
                    if (characteristics.get(CameraCharacteristics.LENS_FACING) == CameraCharacteristics.LENS_FACING_FRONT) {
                        if (Integer.parseInt(camId) == FRONT_CAMERA_ID) {
                            Log.d(LOG_TAG, "Found Front Camera Characteristics");
                            camNames.add(context.getResources().getString(R.string.front_cam_name));
                            camValues.add(Integer.toString(FRONT_CAMERA_ID));
                        } else if (Integer.parseInt(camId) == MONO_CAMERA_ID) {
                            Log.d(LOG_TAG, "Found Mono Camera Characteristics");
                            camNames.add(context.getResources().getString(R.string.mono_cam_name));
                            camValues.add(Integer.toString(MONO_CAMERA_ID));
                        }
                    } else if (characteristics.get(CameraCharacteristics.LENS_FACING) == CameraCharacteristics.LENS_FACING_BACK && Integer.parseInt(camId) == BACK_CAMERA_ID) {
                        Log.d(LOG_TAG, "Found Back Camera Characteristics");
                        camNames.add(context.getResources().getString(R.string.back_cam_name));
                        camValues.add(Integer.toString(BACK_CAMERA_ID));
                    }
                }
