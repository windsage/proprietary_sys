...
static inline int32_t
IClientEnv_register(Object self, Object credentials_val, Object *clientEnv_ptr)
{
  ObjectArg a[2];
  a[0].o = credentials_val;

  int32_t result = Object_invoke(self, IClientEnv_OP_register, a, ObjectCounts_pack(0, 0, 1, 1));
