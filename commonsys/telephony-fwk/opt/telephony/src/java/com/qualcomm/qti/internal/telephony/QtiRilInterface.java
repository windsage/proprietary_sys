...
public class QtiRilInterface implements BaseRilInterface{
    ...
    private static final String ACTION_ADN_INIT_DONE =
            "qualcomm.intent.action.ACTION_ADN_INIT_DONE";
    private static final String ACTION_ADN_RECORDS_IND =
