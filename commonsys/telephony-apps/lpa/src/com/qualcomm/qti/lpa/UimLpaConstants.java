...
public final class UimLpaConstants {
    ...
    public static final int UIM_LPA_PROFILE_USER_CONSENT_OK = 0;
    public static final int UIM_LPA_PROFILE_USER_CONSENT_NOK = 1;
    public static final int UIM_LPA_PROFILE_USER_CONSENT_POSTPONED = 2;

    public static final int UIM_LPA_PROFILE_NO_CONFIRMATION_REQD = 0;
    public static final int UIM_LPA_PROFILE_SIMPLE_CONFIRMATION_REQD = 1;
    public static final int UIM_LPA_PROFILE_STRONG_CONFIRMATION_REQD = 2;
}
