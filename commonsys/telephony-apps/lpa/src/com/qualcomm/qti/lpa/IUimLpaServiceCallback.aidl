...
interface IUimLpaServiceCallback {
    ...
    */
    ...
    void uimLpaConfirmationCodeResponse(in int slot, in int token,
        in int responseCode);
    /**
     * Send Euicc Info2 Response
     *
     * @param euiccInfo2
     *    euiccInfo2 response data
     *
     * @return None
     */
    void uimLpaGetEuiccInfo2Response(in int slot, in int token,
        in int responseCode, in byte[] euiccInfo2);
    /**
     * Send End user consent indication
     *
     * @param user_consent_type
     *
     *
     * @return None
     */
    void uimLpaUserConsentIndication(in int slot, in int user_consent_type );
}
