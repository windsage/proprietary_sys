...
/**
 * uimLpaGetEuiccInfo2 request to retrieve EuiccInfo2 Request
 *
 * @param slot
 *    UIM_LPA_SLOT0  = 0;
 *    UIM_LPA_SLOT1  = 1;
 ...
 *    UIM_LPA_USER_OK      = 1;
 */
int uimLpaGetEuiccInfo2(in int slot, in int token);
    /**
     * uimLpaUserConsent_1_3 request to send user consent with
     * userconsent type and nok reason
     *
     * @param slot
     *    UIM_LPA_SLOT0  = 0;
     *    UIM_LPA_SLOT1  = 1;
     ...
     *
     *    user consent type
     *    UIM_LPA_NO_CONFIRMATION_REQD
     *    UIM_LPA_STRONG_CONFIRMATION_REQD
     *     UIM_LPA_SIMPLE_CONFIRMATION_REQD
     *
     * @return
     *    UIM_LPA_USER_NOT_OK  = 0;
     *    UIM_LPA_USER_OK      = 1;
     */
    int uimLpaUserConsent_1_3(in int slot, in int token, in boolean userOk ,in int nok_reason,in int user_consent_type);
}
