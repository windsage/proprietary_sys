...
typedef int (*ImsMediaSetLocalRenderingParametersFuncPtr)(int, int);
typedef int (*ImsMediasetLocalRenderingDelayFuncPtr)(int);
...
struct ImsMediaApis {
    ...
    ImsMediaSetLocalRenderingParametersFuncPtr setLocalRenderingParameters;
    ImsMediasetLocalRenderingDelayFuncPtr setLocalRenderingSDKDelay;
    ImsMediaIntVoidFuncPtr getDownscaledHeight;
    ImsMediaIntVoidFuncPtr getDownscaledWidth;
};
