...
public class Camera2 extends Camera {
    ...
    private Size mRecordingSize = null;
    ...
    public boolean isRestartNeededOnPreviewSurfaceSizeChanged(Surface surface) {
        ...
        Log.i(this, "new preview size = " + size + " cached previewSize = " + mPreviewSize);
    ...
    public boolean isRestartNeededOnRecordingSurfaceSizeChanged(Surface surface) {
        if (surface == null || mRecordingSize == null
                || !isRecordingStarted()) {
            return false;
        }
        Size size  = ImsMedia.getSurfaceSize(surface);
        Log.i(this, "new recording size = " + size + " cached recording size = "
                + mRecordingSize);
        return !mRecordingSize.equals(size);
    }
    ...
    public void startRecording(Surface previewSurface, Surface recordingSurface)
        ...
        mRecordingSize = ImsMedia.getSurfaceSize(recordingSurface);
        Log.i(this, "startRecording: preview size = " + mPreviewSize
                + " recording size = " + mRecordingSize);
    ...
    private void doCreateCaptureSession(List<OutputConfiguration> o,
        ...
        SessionConfiguration sessionConfig = new SessionConfiguration(
                SessionConfiguration.SESSION_REGULAR, o,
                mContext.getMainExecutor(), l);
