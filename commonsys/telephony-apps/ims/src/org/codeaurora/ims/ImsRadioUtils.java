/*
 * Copyright (c) 2017, 2018-2021, 2023, 2024 Qualcomm Technologies, Inc.
 * All Rights Reserved.
...
import vendor.qti.hardware.radio.ims.V1_7.CallProgressInfoType;
import vendor.qti.hardware.radio.ims.V1_7.CrsType;
...
public class ImsRadioUtils {
    ...
    public static void callDetailsToHal(
        ...
        imsRadioCallDetails.rttMode = rttModeToHal(callDetails.getRttMode());
    ...
    public static DriverCallIms buildDriverCallImsFromHal(
            vendor.qti.hardware.radio.ims.V1_9.CallInfo call) {
        ...
        crsDataFromHal(call.crsData, dc.crsData);
        ...
        callProgressInfoFromHal(call.callProgInfo, dc.callProgressInfo);
        ...
        if (call.hasFailCause) {
            ...
            if (failCause != CallFailCause.CALL_FAIL_INVALID) {
                ...
                dc.mCallFailReason = mapSipErrorFromCallFailCause(failCause);
    ...
    public static CallDetails getCallDetails(
            vendor.qti.hardware.radio.ims.V1_9.CallDetails inCallDetails) {
        ...
        if (inCallDetails.rttMode != RttMode.RTT_MODE_INVALID) {
            outCallDetails.rttMode = rttModeFromHal(inCallDetails.rttMode);
        }
    ...
    public static int mapHidlToFrameworkResponseResult(int hidlResult) {
        switch (hidlResult) {
            ...
            for (int i = 0; i < listLen; i++) {
                ...
                if (fromInfo != null) {
                    ...
                    if (fromInfo.status == StatusType.STATUS_ENABLED &&
                            fromInfo.restrictCause != Integer.MAX_VALUE &&
                    ...
                    toList[i].rttMode = rttModeFromHal(fromInfo.rttMode);
    ...
    public static vendor.qti.hardware.radio.ims.V1_4.DialRequest
        ...
        return ImsRadioUtils.buildDialRequest(address, clirMode, callDetails, isEncrypted,
                null);
    }
    ...
    public static vendor.qti.hardware.radio.ims.V1_4.DialRequest
        ...
        if (callDetails != null) {
            ...
            if (redialInfo != null &&
                    redialInfo.getRetryCallFailCause() != ImsReasonInfo.CODE_UNSPECIFIED) {
                callDetails.addExtra(QtiCallConstants.EXTRA_RETRY_CALL_FAIL_REASON +
                        "=" + getCallFailCauseForImsReason(redialInfo.getRetryCallFailCause()));
            }
            if (redialInfo != null &&
                    redialInfo.getRetryCallFailRadioTech() != RadioTech.RADIO_TECH_UNKNOWN) {
                callDetails.addExtra(QtiCallConstants.EXTRA_RETRY_CALL_FAIL_RADIOTECH +
                        "=" + mapRadioTechToHal(redialInfo.getRetryCallFailRadioTech()));
            }
    ...
    protected static ArrayList<ServiceStatus> handleSrvStatus(ArrayList<ServiceStatusInfo> inList) {
    ...
    public static HoInfo handoverFromHal(HandoverInfo inHandover) {
        ...
        if (inHandover.hasHoExtra) {
            outHandover.setExtra(extraTypeFromHal(inHandover.hoExtra.type),
                                 ImsUtils.toByteArray(inHandover.hoExtra.extraInfo));
        }
    ...
    public static ImsCallForwardTimerInfo[] buildCFStatusResponseFromHal(
            ArrayList<CallForwardInfo> inCfInfoList) {
    ...
    public static CallModify callModifyFromHal(
            vendor.qti.hardware.radio.ims.V1_9.CallModifyInfo callModifyInfo) {
    ...
    public static int[] voWiFiCallQualityFromHal(int voWiFiCallQuality) {
        int[] ret = new int[1];
    ...
    public static UssdInfo ussdInfoFromHal(int type, String msg,
            SipErrorInfo errorDetails) {
        return new UssdInfo(ussdTypeFromHal(type), msg,
                            errorDetails.errorCode,
                            errorDetails.errorString);
    }

    public static int ussdTypeFromHal(int type) {
        switch (type) {
    ...
    public static int crsTypeFromHal(int type) {
        switch (type) {
            ...
            case CrsType.AUDIO | CrsType.VIDEO:
                return QtiCallConstants.CRS_TYPE_AUDIO
    ...
    public static void crsDataFromHal(vendor.qti.hardware.radio.ims.V1_7.CrsData from,
            CrsData to) {
        to.setCrsType(crsTypeFromHal(from.type));
        to.setOriginalCallType(callTypeFromHal(from.originalCallType));
    }

    public static int callProgressInfoTypeFromHal(int type) {
        switch (type) {
    ...
    public static void callProgressInfoFromHal(
            vendor.qti.hardware.radio.ims.V1_7.CallProgressInfo from, CallProgressInfo to) {
        to.setType(callProgressInfoTypeFromHal(from.type));
    ...
    public static int getCallForwardReasonFromSsData(int reason) {
        switch(reason) {
    ...
    */
    ...
    public static int voiceInfoTypeFromHal(int voiceInfo) {
        switch (voiceInfo) {
            case VoiceInfo.VOICE_INFO_SILENT:
                return ImsUtils.VOICE_INFO_SILENT;
            case VoiceInfo.VOICE_INFO_SPEECH:
                return ImsUtils.VOICE_INFO_SPEECH;
            case VoiceInfo.VOICE_INFO_UNKNOWN:
            default:
    ...
    @VisibleForTesting
    public static int mapSipErrorFromCallFailCause(int callFailCause) {
    ...
    public static int rttModeToHal(int rttMode) {
        switch (rttMode) {
    ...
    @VisibleForTesting
    public static int rttModeFromHal(int rttMode) {
        switch (rttMode) {
    ...
    public static vendor.qti.hardware.radio.ims.V1_9.VosActionInfo fromVosActionInfo(
            VosActionInfo from) {
        if (from == null) {
            return null;
        }

        vendor.qti.hardware.radio.ims.V1_9.VosActionInfo to =
            new vendor.qti.hardware.radio.ims.V1_9.VosActionInfo();
        if (from.getVosMoveInfo() != null) {
            to.hasVosMoveInfo = true;
            to.vosMoveInfo = fromVosMoveInfo(from.getVosMoveInfo());
        }

        if (from.getVosTouchInfo() != null) {
            to.hasVosTouchInfo = true;
    ...
    private static vendor.qti.hardware.radio.ims.V1_9.VosMoveInfo fromVosMoveInfo(
            VosMoveInfo from) {
        vendor.qti.hardware.radio.ims.V1_9.VosMoveInfo vosMoveInfo =
            new vendor.qti.hardware.radio.ims.V1_9.VosMoveInfo();
    ...
    private static vendor.qti.hardware.radio.ims.V1_9.VosTouchInfo fromVosTouchInfo(
            VosTouchInfo from) {
        vendor.qti.hardware.radio.ims.V1_9.VosTouchInfo vosTouchInfo =
            new vendor.qti.hardware.radio.ims.V1_9.VosTouchInfo();
    ...
    private static vendor.qti.hardware.radio.ims.V1_9.Coordinate2D fromCoordinate2D(
            Coordinate2D from) {
        vendor.qti.hardware.radio.ims.V1_9.Coordinate2D coordinate2D =
            new vendor.qti.hardware.radio.ims.V1_9.Coordinate2D();
    ...
    public static vendor.qti.hardware.radio.ims.V1_9.CallModifyInfo
        migrateCallModifyInfoToV19(CallModifyInfo callModifyInfo) {
        if (callModifyInfo == null) {
            return null;
        }

        vendor.qti.hardware.radio.ims.V1_9.CallModifyInfo callModifyInfoV19 =
            new vendor.qti.hardware.radio.ims.V1_9.CallModifyInfo();
        callModifyInfoV19.callIndex = callModifyInfo.callIndex;
        callModifyInfoV19.hasCallDetails = callModifyInfo.hasCallDetails;
        callModifyInfoV19.callDetails = ImsRadioUtilsV19.migrateCallDetails(
                ImsRadioUtilsV16.migrateCallDetails(callModifyInfo.callDetails));
        callModifyInfoV19.failCause = callModifyInfo.failCause;

        return callModifyInfoV19;
    }
}
