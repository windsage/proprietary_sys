...
public class ImsRadioUtilsV16 {
    ...
    public static vendor.qti.hardware.radio.ims.V1_6.DialRequest
        ...
        if (redialInfo == null) {
            redialInfo = new RedialInfo(ImsReasonInfo.CODE_UNSPECIFIED,
                    RadioTech.RADIO_TECH_UNKNOWN);
        }
        dialRequest.redialInfo.callFailReason =
                ImsRadioUtilsV15.getCallFailCauseForImsReason(
                redialInfo.getRetryCallFailCause());
        dialRequest.redialInfo.callFailRadioTech =
                ImsRadioUtils.mapRadioTechToHal(
                redialInfo.getRetryCallFailRadioTech());
    ...
    public static void callDetailsToHal(
        ...
        imsRadioCallDetails.rttMode = ImsRadioUtils.rttModeToHal(callDetails.getRttMode());
