/*
 * Copyright (c) 2014, 2019, 2023 Qualcomm Technologies, Inc.
 * All Rights Reserved.
...
public abstract class ImsPhoneBaseCommands implements ImsPhoneCommandsInterface {
    ...
    public ImsPhoneBaseCommands(Context context) {
        ...
        mPreAlertingCallInfoRegistrants = new WakeLockRegistrantList(mNotifyWakeLock);
    }
    ...
    @Override
    public void registerForPreAlertingCallInfo(Handler h, int what, Object obj) {
        Registrant r = new WakeLockRegistrant(h, what, obj, mNotifyWakeLock);
        mPreAlertingCallInfoRegistrants.add(r);
    }

    @Override
    public void unregisterForPreAlertingCallInfo(Handler h) {
        mPreAlertingCallInfoRegistrants.remove(h);
    }
}
