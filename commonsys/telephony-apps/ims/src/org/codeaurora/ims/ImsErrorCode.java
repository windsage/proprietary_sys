/*
 * Copyright (c) 2018, 2020-2021, 2024 Qualcomm Technologies, Inc.
 * All Rights Reserved.
...
public class ImsErrorCode {
    ...
    /* USSD CS Fallback */
    public static final int USSD_CS_FALLBACK = 47;
    public static final int SEND_SIP_DTMF_FAILED = 48;

    /* Call Forward related failures */
    public static final int CF_SERVICE_NOT_REGISTERED = 49;

    /* RIL failed the request due to internal failures */
    public static final int RIL_FAILED_INTERNAL = 50;
}
