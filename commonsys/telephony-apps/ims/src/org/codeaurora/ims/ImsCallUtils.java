/*
 * Copyright (c) 2015-2016, 2018-2023 Qualcomm Technologies, Inc.
 * All Rights Reserved.
   ...
   /** Checks if a call is incoming call
    ...
    public static int convertImsConfigToImsConfigItem(int config) {
        switch(config) {
            ...
            case QtiCallConstants.B2C_ENRICHED_CALLING_MODE:
                return ImsConfigItem.B2C_ENRICHED_CALLING_MODE;
            case QtiCallConstants.DATA_CHANNEL_MODE:
                return ImsConfigItem.DATA_CHANNEL_MODE;
            case QtiCallConstants.VOLTE_PROVISIONING_RESTRICT_HOME:
                return ImsConfigItem.VOLTE_PROVISIONING_RESTRICT_HOME;
            case QtiCallConstants.VOLTE_PROVISIONING_RESTRICT_ROAMING:
     ...
     */
    public static void updateImsCallProfileVerstatInfo(VerstatInfo verstatInfo,
    ...
    public static void removeExtras(Bundle callExtras, List<String> extrasToRemove) {
        if (callExtras == null || extrasToRemove == null) {
            return;
        }
    ...
    // creates deep copy of ImsCallProfile
    public static ImsCallProfile copyImsCallProfile(ImsCallProfile profile) {
        ImsStreamMediaProfile newImsStreamMediaProfile = new ImsStreamMediaProfile();
        newImsStreamMediaProfile.copyFrom(profile.getMediaProfile());
        ImsCallProfile newImsCallProfile = new ImsCallProfile(profile.getServiceType(),
                profile.getCallType(), profile.getCallExtras().deepCopy(),
        ...
        newImsCallProfile.setAcceptedRtpHeaderExtensionTypes(
                profile.getAcceptedRtpHeaderExtensionTypes());
        newImsCallProfile.setEmergencyServiceCategories(
                profile.getEmergencyServiceCategories());
        ArrayList<String> newEmergencyUrns = new ArrayList<>();
        newEmergencyUrns.addAll(profile.getEmergencyUrns());
        newImsCallProfile.setEmergencyUrns(newEmergencyUrns);
        newImsCallProfile.setEmergencyCallRouting(profile.getEmergencyCallRouting());
        newImsCallProfile.setEmergencyCallTesting(profile.isEmergencyCallTesting());
        newImsCallProfile.setHasKnownUserIntentEmergency(profile.hasKnownUserIntentEmergency());
