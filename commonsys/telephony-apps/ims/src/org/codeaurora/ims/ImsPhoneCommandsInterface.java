/*
 * Copyright (c) 2014, 2019-2021, 2023 Qualcomm Technologies, Inc.
 * All Rights Reserved.
...
public interface ImsPhoneCommandsInterface {
     ...
     *  ar.result is null on success and failure
     */
    void sendDtmf(int callId, char c, Message result);
     ...
     *  ar.result is null on success and failure
     */
    void startDtmf(int callId, char c, Message result);
     ...
     *  ar.result is null on success and failure
     */
    void stopDtmf(int callId, Message result);
    ...
    void unregisterForRttMessage(Handler h);

    void registerForVoiceInfo(Handler h, int what, Object obj);

    void unregisterForVoiceInfo(Handler h);

    void registerForPreAlertingCallInfo(Handler h, int what, Object obj);

    void unregisterForPreAlertingCallInfo(Handler h);

    void registerForUssdInfo(Handler h, int what, Object obj);

    void unregisterForUssdInfo(Handler h);

    void registerForSipDtmfInfo(Handler h, int what, Object obj);

    void unregisterForSipDtmfInfo(Handler h);

    void registerForSrvDomainChanged(Handler h, int what, Object obj);

    void unregisterForSrvDomainChanged(Handler h);

    void registerForConferenceCallStateCompleted(Handler h, int what, Object obj);

    void unregisterForConferenceCallStateCompleted(Handler h);

    void queryCallForwardStatus(int cfReason, int serviceClass, String number, Message response,
            boolean expectMore);

    void suppSvcStatus(int operationType, int facility, String[] inCbNumList, String password,
            int serviceClass, Message response, boolean expectMore);
}
