...
public class SuppSvcResponse {
    ...
    /* queryCallBarring response provides this info */
    ...
    public void setPasswordRequired(boolean password) {
        mPasswordRequired = password;
    }
    ...
    public String toString() {
        return ("SuppSvcResponse status: " + mStatus +
                ...
                " passwordRequired: " + mPasswordRequired);
    }
}
