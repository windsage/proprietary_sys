/*
 * Copyright (c) 2015, 2018, 2020-2021, 2023 Qualcomm Technologies, Inc.
 * All Rights Reserved.
...
public class ImsCallSessionCallbackHandler {
    ...
    public void callSessionInitiating(final ImsCallProfile profile) {
        if (mListener != null) {
            Log.i(this, "callSessionInitiating :: profile=" + profile);
            try {
                mListener.callSessionInitiating(profile);
            } catch (RuntimeException r) {
                Log.e(this, "callSessionInitiating :: RuntimeException " + r);
            }
        }
    }
    ...
    public void callSessionInitiatingFailed(final ImsReasonInfo reason) {
        if (mListener != null) {
            Log.i(this, "callSessionInitiatingFailed :: reason=" + reason);
            try {
                mListener.callSessionInitiatingFailed(reason);
            } catch (RuntimeException r) {
                Log.e(this, "callSessionInitiatingFailed :: RuntimeException " + r);
            }
        }
    }
   ...
   /**
    ...
    /**
     * Notifies about the received USSD message.
     *
     * @param mode USSD mode.
     * @param ussdMessage USSD message.
     */
    public void callSessionUssdMessageReceived(final int mode, final String ussdMessage) {
        if (mListener != null) {
            Log.i(this, "callSessionUssdMessageReceived :: mode=" + mode);
            try {
                mListener.callSessionUssdMessageReceived(mode, ussdMessage);
            } catch (RuntimeException r) {
                Log.e(this, "callSessionUssdMessageReceived :: RuntimeException " + r);
            }
        }
    }

    /**
     * Notifies when call transfer has failed to complete.
     *
     * @param reasonInfo The reason for the failure.
     */
    public void callSessionTransferFailed(final ImsReasonInfo reasonInfo) {
        if (mListener != null) {
            Log.i(this, "callSessionTransferFailed :: reasonInfo = " + reasonInfo);
            try {
                mListener.callSessionTransferFailed(reasonInfo);
            } catch (RuntimeException r) {
                Log.e(this, "callSessionTransferFailed :: RuntimeException " + r);
            }
        }
    }

    /**
     * Notifies when call has successfully transferred.
     */
    public void callSessionTransferred() {
        if (mListener != null) {
            ...
            try {
                ...
                Log.e(this, "callSessionTransferred :: RuntimeException " + r);
            }
        }
    }
