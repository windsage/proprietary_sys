...
public class ImsConfigItem {
    ...
    /* Value for this item is: (String)
     * An obfuscated string defined by the carrier
     * to indicate VoWiFi entitlement status.
     */
    public static final int VOICE_OVER_WIFI_ENTITLEMENT_ID = 76;

    /* Value for this item is: (Int)
     * B2C ENRICHED CALL Preference
     * Values:
     *   - 0 -- DISABLED
     *   - 1 -- ENABLED
     *
     ...
     * if the value is not any of the above.
     */
    public static final int B2C_ENRICHED_CALLING_MODE = 77;
     ...
     * if the value is not any of the above.
     */
    public static final int DATA_CHANNEL_MODE = 78;

    /* Value for this item is: (Int)
     * VoLTE provisioning restriction status in home network
     * Values:
     *   - 0 -- DISABLED
     *   - 1 -- ENABLED
     *
     ...
     * if the value is not any of the above.
     */
    public static final int VOLTE_PROVISIONING_RESTRICT_HOME = 79;

    /* Value for this item is: (Int)
     * VoLTE provisioning restriction status in roaming network
     * Values:
     *   - 0 -- DISABLED
     *   - 1 -- ENABLED
     *
     ...
     * if the value is not any of the above.
     */
    public static final int VOLTE_PROVISIONING_RESTRICT_ROAMING = 80;
