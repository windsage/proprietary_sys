...
public class MessageId {
     ...
     * MsgType: REQUEST
     *
     * Description:Request USSD over ims.
     */
     ...
     * MsgType: REQUEST
     *
     * Description:Request cancel USSD over ims.
     */
     ...
     * MsgType: REQUEST
     *
     * Description:Request send SIP DTMF string to modem.
     */
    public static final int REQUEST_SIP_DTMF = 66;

    /**
     * MsgType: REQUEST
     * Description: Request send screen size and max avc/hevc codec size to modem
     */
     ...
     *
     * "response" is message MultiSimVoiceCapability
     *
     * Valid errors:
     *  SUCCESS
     *  GENERIC_FAILURE
    ...
    /**
     * MsgType: REQUEST
     * Description: Request exit SCBM mode
     */
     ...
     * MsgType: REQUEST
     *
     * Description:Request send VOS support status to modem.
     */
    public static final int REQUEST_SEND_VOS_SUPPORT_STATUS = 70;

    /**
     * MsgType: REQUEST
     *
     * Description:Request send VOS action info to modem.
     */
    public static final int REQUEST_SEND_VOS_ACTION_INFO = 71;

    /**
     * MsgType: REQUEST
     *
     * Description:Request enable glasses free 3d video capability to modem.
     */
    public static final int REQUEST_SET_GLASSES_FREE_3D_VIDEO_CAPABILITY = 72;

    /**
     * MsgType: REQUEST
     *
     * Description:Send modem request to abort conference in progress.
     */
    public static final int REQUEST_ABORT_CONFERENCE = 73;
     ...
     * MsgType: INDICATION
     *
     * Description: Indication from modem for IMS USSD received.
     *
     */
    public static final int UNSOL_USSD_RECEIVED = 236;

    /**
     * UNSOL_SIP_DTMF_RECEIVED
     *
     * MsgType: INDICATION
     *
     * Description: Indication from modem for SIP DTMF received.
     *
     */
     public static final int UNSOL_SIP_DTMF_RECEIVED = 237;

    /**
     * UNSOL_SERVICE_DOMAIN_CHANGED
     *
     * MsgType: INDICATION
     *
     * Description: Indication from modem for Service Domain change.
     *
     */
    public static final int UNSOL_SERVICE_DOMAIN_CHANGED = 238;

    /**
     * UNSOL_CONFERENCE_CALL_STATE_COMPLETED
     *
     * MsgType: INDICATION
     *
     * Description: Indication from QMIRIL to notify all call states related to conference are
     * notified to telephony.
     *
     */
    public static final int UNSOL_CONFERENCE_CALL_STATE_COMPLETED = 239;

    /**
     * UNSOL_SCBM_UPDATE_IND
     *
     * MsgType: INDICATION
     *
     * Description: Indication from QMIRIL to notify Telephony when Modem has entered
     * or exited Sms Callback Mode.
     *
     */
    public static final int UNSOL_SCBM_UPDATE_IND = 240;

    /**
     * UNSOL_INCOMING_DTMF_START
     *
     * MsgType: INDICATION
     *
     * Description: Indication from QMIRIL to notify incoming DTMF start
    ...
    /**
     * UNSOL_INCOMING_DTMF_STOP
     *
     * MsgType: INDICATION
     *
     * Description: Indication from QMIRIL to notify incoming DTMF stop
     * after call is established.
     *
     */
    ...
    /**
     * UNSOL_MULTI_SIM_VOICE_CAPABILITY_CHANGED
     *
     * MsgType: INDICATION
     *
     * Description: Indication from QMIRIL to notify multi sim voice capability when modem is
     * switched between DSDS, DSDA and PSEUDO_DSDA.
     */
    public static final int UNSOL_MULTI_SIM_VOICE_CAPABILITY_CHANGED = 243;

    /**
     * UNSOL_PRE_ALERTING_CALL_INFO_AVAILABLE
     *
     * MsgType: INDICATION
     *
     * Description: Indication from QMIRIL to notify pre alerting call information like
     * callcomposer, ecnam.
     */
    public static final int UNSOL_PRE_ALERTING_CALL_INFO_AVAILABLE = 244;

    /**
     * UNSOL_INCOMING_CALL_AUTO_REJECTED
     *
     * MsgType: INDICATION
     *
     * Description: Indication from QMIRIL for the auto call rejected with callcomposer, ecnam.
     */
    public static final int UNSOL_INCOMING_CALL_AUTO_REJECTED = 245;

    /**
     * UNSOL_C_IWLAN_NOTIFICATION
     *
     * MsgType: INDICATION
     *
     * Description: Indication from QMIRIL related to C_IWLAN notifications
     */
    public static final int UNSOL_C_IWLAN_NOTIFICATION = 246;

   /**
     * UNSOL_SRTP_ENCRYPTION_UPDATE
     *
     * MsgType: INDICATION
     *
     * Description: Indication from QMIRIL related to notify which SRTP categories is supported.
     */
    public static final int UNSOL_SRTP_ENCRYPTION_UPDATE = 247;
