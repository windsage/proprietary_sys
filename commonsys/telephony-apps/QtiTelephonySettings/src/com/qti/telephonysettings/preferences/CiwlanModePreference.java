...
public class CiwlanModePreference extends Preference {

    private static final String TAG = "CiwlanModePreference";
    ...
    public CiwlanModePreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    private void checkFeatureAvailability() {
        if (mExtTelephonyManager.isFeatureSupported(
