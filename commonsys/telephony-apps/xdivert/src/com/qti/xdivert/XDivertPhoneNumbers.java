...
public class XDivertPhoneNumbers extends Activity {
    ...
    private void checkDangerousPermissions() {
        if (checkSelfPermission(Manifest.permission.POST_NOTIFICATIONS) ==
            ...
            Log.d(LOG_TAG,"XDivertPhoneNumbers : POST_NOTIFICATIONS is granted");
            setupView();
        }
        else {
            Log.d(LOG_TAG,"XDivertPhoneNumbers : POST_NOTIFICATIONS is NOT granted");
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions,
        ...
        if (requestCode == POST_NOTIFICATIONS_PERMISSION_CODE) {
            Log.v(LOG_TAG, "request Permission :" + Arrays.toString(permissions));

            if (grantResults.length > 0) {
                Log.d(LOG_TAG, "grantResults.length = " + grantResults.length);
                granted = true;
            ...
            runtimePermissionAlertDialog(R.string.grant_permissions_prompt);
        }
    }

    private void runtimePermissionAlertDialog(int resId) {
        ...
        dialog.setTitle(R.string.xdivert_title);
