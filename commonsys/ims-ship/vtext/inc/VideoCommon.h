...
typedef enum ENABLED_FEATURE_SET {
  LEGACY_FEATURE_SET = 0,
  VENDOR_1_0_FEATURE_SET = 1,
  DIVAR_2_1_FEATURE_SET = 2
} VT_ENABLED_FEATURE_SET;
...
typedef struct QpVideoConfig {
  ...
  uint8_t bVideoRotationSupport;
  VT_ENABLED_FEATURE_SET iEnableFeatureSet;
} QP_VIDEO_CONFIG;

typedef enum eKEY_BITRATE_MODES {

  VT_BITRATE_CONST_SKIP_ALLOWED = 0,   ///< constant bitrate, frame skipping allowed
  VT_BITRATE_CONST = 1,          ///< constant bitrate, keep all frames
  VT_BITRATE_VARIABLE_SKIP_ALLOWED = 2,  ///< bitrate can vary, frame skipping allowed
  VT_BITRATE_VARIABLE = 3,         ///< bitrate can vary, keep all frames
  VT_BITRATE_IGNORE = 7,         ///< bitrate can be exceeded at will to achieve
...
} VT_KEY_BITRATE_MODES;

typedef enum eKEY_BITRATE_RC_MODES {
  BITRATE_MODE_VBR = 1,
  BITRATE_MODE_CBR = 2,
  BITRATE_MODE_CBR_FD = 3  
} VT_KEY_BITRATE_RC_MODES;
