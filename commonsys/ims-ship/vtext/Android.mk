...
LOCAL_HEADER_LIBRARIES += libdiag_headers_system
...
LOCAL_C_INCLUDES += frameworks/av/camera/include/camera/android/hardware/
...
LOCAL_SRC_FILES += src/VTAImageReader.cpp
