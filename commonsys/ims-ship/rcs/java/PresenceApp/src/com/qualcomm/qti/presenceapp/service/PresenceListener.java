    ...
    public void serviceUnAvailable(StatusCode statusCode) throws RemoteException {
        ...
        Runnable msg = new Runnable() {
            ...
            public void run() {
                ...
                if(UceService.isPublishTriggerReceived.get(mTabInstance) != null) {
                    UceService.isPublishTriggerReceived.remove(mTabInstance);
                }
            }
        };
        mHandler.post(msg);
        ...
        Runnable msg = new Runnable() {
            ...
            public void run() {
                Toast.makeText(MainActivity.mCtx,
                        message,
                        Toast.LENGTH_SHORT).show();
                UceService.isPublishTriggerReceived.put(mTabInstance, true);
