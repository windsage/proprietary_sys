...
LOCAL_STATIC_JAVA_LIBRARIES += com.qualcomm.qti.imscmservice-V2.0-java
LOCAL_STATIC_JAVA_LIBRARIES += com.qualcomm.qti.imscmservice-V2.1-java
LOCAL_STATIC_JAVA_LIBRARIES += com.qualcomm.qti.imscmservice-V2.2-java
LOCAL_STATIC_JAVA_LIBRARIES += vendor.qti.ims.imscmaidlservice-V1-java
