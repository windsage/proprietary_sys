...
public class ConnectionGlobalData  {
    ...
    /**
     * add AIDL specific data 
     */

    public ConnectionManagerService.CMAidlWrapper connAidlMgr = null;

    public vendor.qti.ims.imscmaidlservice.ConfigData aidlConfigdata = null;
    public vendor.qti.ims.imscmaidlservice.AutoConfigResponse aidlAcsResponse = null;
    public vendor.qti.ims.imscmaidlservice.AutoConfig aidlAutoConfigData = null;

    //Service Listener
    public ConnectionManagerAidlListenerImpl mConnMgrAidlListener = null;

    //Map of AIDL Connection objects with feature tag
    public HashMap<String, CMAidlConnection> aidlConnectionMap = new
                                      HashMap<String, CMAidlConnection>();
    public int aidlAcsTriggerReason =
    vendor.qti.ims.imscmaidlservice.AutoconfigTriggerReason.AUTOCONFIG_INVALID_TOKEN;
    public int aidlUnsupportedStatusCode = vendor.qti.ims.imscmaidlservice.StatusCode.UNSUPPORTED;
    public ServiceListenerToken aidlServiceListenerId = new ServiceListenerToken();
    public int aidlSuccessStatusCode = vendor.qti.ims.imscmaidlservice.StatusCode.SUCCESS;
}
