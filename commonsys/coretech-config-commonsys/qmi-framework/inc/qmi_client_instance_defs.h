...
/******************************************************************************
  ---------------------------------------------------------------------------
  Copyright (c) 2011-2017, 2020, 2021 Qualcomm Technologies, Inc.
  All Rights Reserved.
...
typedef enum
{
  ...
  QMI_CLIENT_QMUX_REV_RMNET_INSTANCE_0 = QMI_CLIENT_QMUX_BASE_INSTANCE + QMI_CONN_ID_REV_RMNET_0,
  QMI_CLIENT_QMUX_REV_RMNET_INSTANCE_1,
  QMI_CLIENT_QMUX_REV_RMNET_INSTANCE_2,
  QMI_CLIENT_QMUX_REV_RMNET_INSTANCE_3,
  QMI_CLIENT_QMUX_REV_RMNET_INSTANCE_4,
  QMI_CLIENT_QMUX_REV_RMNET_INSTANCE_5,
  QMI_CLIENT_QMUX_REV_RMNET_INSTANCE_6,
  QMI_CLIENT_QMUX_REV_RMNET_INSTANCE_7,
  QMI_CLIENT_QMUX_REV_RMNET_INSTANCE_8,
  ...
  QMI_CLIENT_QMUX_REV_RMNET_USB_INSTANCE_0 = QMI_CLIENT_QMUX_BASE_INSTANCE + QMI_CONN_ID_REV_RMNET_USB_0,
  QMI_CLIENT_QMUX_REV_RMNET_USB_INSTANCE_1,
  QMI_CLIENT_QMUX_REV_RMNET_USB_INSTANCE_2,
  QMI_CLIENT_QMUX_REV_RMNET_USB_INSTANCE_3,
  QMI_CLIENT_QMUX_REV_RMNET_USB_INSTANCE_4,
  QMI_CLIENT_QMUX_REV_RMNET_USB_INSTANCE_5,
  QMI_CLIENT_QMUX_REV_RMNET_USB_INSTANCE_6,
  QMI_CLIENT_QMUX_REV_RMNET_USB_INSTANCE_7,
  QMI_CLIENT_QMUX_REV_RMNET_USB_INSTANCE_8,
  ...
  QMI_CLIENT_QMUX_RMNET_MHI_INSTANCE_2 = QMI_CLIENT_QMUX_BASE_INSTANCE + QMI_CONN_ID_RMNET_MHI2_0,
  QMI_CLIENT_QMUX_RMNET_MHI_INSTANCE_3 = QMI_CLIENT_QMUX_BASE_INSTANCE + QMI_CONN_ID_RMNET_MHI3_0,
