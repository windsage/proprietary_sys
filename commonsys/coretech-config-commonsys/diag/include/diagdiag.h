...
PACKET   DIAG_FEATURE_QUERY_REQ

PURPOSE  Request sent to Query Feature Mask
============================================================================*/
...
} diag_feature_query_rsp;

/*==========================================================================

PACKET   DIAG_HW_ACCEL_QUERY_REQ

PURPOSE  Request sent for HW ACCELERATION Query
============================================================================*/
...
}diag_hw_accel_query_cmd_req;

typedef PACK(struct){
  uint8 hw_accel_type;
  uint8 hw_accel_version;
  unsigned int diag_id_mask_supported;
  unsigned int diag_id_mask_enabled;
}diag_id_hw_accel_status;

/*==========================================================================

PACKET   DIAG_CONFIGURE_NEW_PKT

PURPOSE  Request sent for configure new Diagid based packet
============================================================================*/

typedef PACK(struct) {
    diag_pkt_header_t header;
    uint8 version;
    uint8 pkt_format_mask;
}diag_cmd_pkt_format_select_req;
...
typedef PACK(struct) {
    ...
    uint8 pkt_format_mask;
    uint8 status;
}diag_cmd_pkt_format_select_resp;
