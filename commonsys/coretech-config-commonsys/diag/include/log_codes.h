...
#define LOG_ETH_STATS_C                                       ((0xE4C) + LOG_1X_BASE_C)
#define LOG_ETH_CONFIG_C                                      ((0xE51) + LOG_1X_BASE_C)
#define LOG_ECPRISS_STATS_C                                   ((0xE87) + LOG_1X_BASE_C)
#define LOG_ECPRISS_CONFIG_C                                  ((0xE89) + LOG_1X_BASE_C)


/* The last defined DMSS log code */
#define LOG_1X_LAST_C                                        ((0xE89) + LOG_1X_BASE_C)
