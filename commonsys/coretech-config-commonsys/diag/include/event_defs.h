...
/*=======================================================================
Copyright (c) 2001-2021, 2024 Qualcomm Technologies, Inc.
All Rights Reserved.
...
typedef enum
{
  ...
  EVENT_F_RESERVED_97                                                            = 0xCFB, /* 3323 */
  EVENT_NR5G_RRC_MCG_FAILURE_V2                                                  = 0xCFC, /* 3324 */
  EVENT_NR5G_RRC_HO_FAILURE_V5                                                   = 0xCFD, /* 3325 */
  EVENT_NR5G_RRC_SCG_FAILURE_V2                                                  = 0xCFE, /* 3326 */
  EVENT_CFCM_MONITOR_TRIGGERED_V2                                                = 0xCFF, /* 3327 */
  EVENT_CONNECTIVITY_EVENT_WLAN_SHUTDOWN                                         = 0xD01, /* 3329 */
  EVENT_WLAN_CAL_FAIL                                                            = 0xD02, /* 3330 */
  EVENT_GSM_DTA_GAP_OPENED                                                       = 0xD03, /* 3331 */
  EVENT_GSM_DTA_GAP_CLOSED                                                       = 0xD04, /* 3332 */
  EVENT_LTE_RRC_IRAT_HO_TO_EUTRAN_START_EXT                                      = 0xD06, /* 3334 */
  EVENT_WWANME_NR5G_RTT_DEBUG                                                    = 0xD07, /* 3335 */
  EVENT_GPS_HLOS_XTRA_DIAG_EVENT_CONFIG_HANDSHAKE                                = 0XD4B, /* 3403 */
  EVENT_GPS_HLOS_XTRA_DIAG_EVENT_DELETION                                        = 0XD4C, /* 3404 */
  EVENT_GPS_HLOS_XTRA_DIAG_EVENT_GPS_LOCK                                        = 0XD4D, /* 3405 */
  EVENT_GPS_HLOS_XTRA_DIAG_EVENT_DOWNLOAD                                        = 0xD4E, /* 3406 */
  EVENT_GPS_HLOS_XTRA_DIAG_EVENT_SSL_SETUP                                       = 0xD4F, /* 3407 */
  EVENT_GPS_HLOS_XTRA_DIAG_EVENT_TIME_DOWNLOAD                                   = 0XD50, /* 3408 */
  EVENT_GPS_HLOS_XTRA_DIAG_EVENT_BACKHAUL                                        = 0xD51, /* 3409 */
  EVENT_GPS_HLOS_XTRA_DIAG_EVENT_POWER_STATE                                     = 0xD52, /* 3410 */
  EVENT_GPS_HLOS_XTRA_DIAG_EVENT_LIA                                             = 0xD53, /* 3411 */
  EVENT_GPS_HLOS_XTRA_DIAG_EVENT_INIT_COMPLETE                                   = 0xD6B, /* 3435 */
  EVENT_DATACSM_LINK_CHANGE_NOTIFICATION_OLD                                     = 0xD64, /* 3428 */
  EVENT_DATACSM_LINK_CHANGE_NOTIFICATION                                         = 0xD72, /* 3442 */
  EVENT_DATACSM_ECPRISS_CONFIG_NOTIFICATION                                      = 0xD7E, /* 3454 */
