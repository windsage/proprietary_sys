...
#define MSG_BUILD_MASK_MSG_SSID_PROFILER  (MSG_LVL_HIGH)
  ...
  #define MSG_BUILD_MASK_MSG_SSID_MGPME     (MSG_LVL_MED|MSG_INT_MASK_5 | \
             ...
             MSG_MASK_26|MSG_MASK_27|MSG_MASK_28)
#endif
...
#define MSG_BUILD_MASK_MSG_SSID_QWES            (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_ONDEVICE_HLOS   (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_AWARE_LOCATION  (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_AWARE_BOOTUP    (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_AWARE_CONFIG    (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_AWARE_DATA      (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_AWARE_SENSOR    (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_MGPME_MC        (MSG_LVL_MED | MSG_INT_MASK_5 | \
                                                 MSG_INT_MASK_6 | MSG_INT_MASK_7 | MSG_INT_MASK_8)
...
#define MSG_BUILD_MASK_MSG_SSID_AUD_OFFL_SVC         (MSG_LVL_LOW)
...
#define MSG_BUILD_MASK_MSG_SSID_DS_EMAC           (MSG_LVL_HIGH)
...
/* WEAR AON related SSID's */
#define MSG_BUILD_MASK_MSG_SSID_WEAR_AON_SNS_PLATFORM               (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_WEAR_AON_SNS_SENSOR_INT             (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_WEAR_AON_SNS_FRAMEWORK              (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_WEAR_AON_SNS_SENSOR_EXT             (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_WEAR_AON_SNS                        (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_WEAR_AON_COREBSP_COAPP              (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_WEAR_AON_Display_SM                 (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_WEAR_AON_Display_RM                 (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_WEAR_AON_Display_Driver             (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_WEAR_AON_Display_Platform           (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_WEAR_AON_Display_GPU_Driver         (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_WEAR_AON_CONN_MGR                   (MSG_LVL_LOW|MSG_INT_MASK_5|MSG_INT_MASK_6|MSG_INT_MASK_7|MSG_INT_MASK_8|MSG_INT_MASK_9|MSG_INT_MASK_10|MSG_INT_MASK_11)
#define MSG_BUILD_MASK_MSG_SSID_WEAR_AON_WEAR_MGR                   (MSG_LVL_LOW|MSG_INT_MASK_5|MSG_INT_MASK_6|MSG_INT_MASK_7|MSG_INT_MASK_8|MSG_INT_MASK_9|MSG_INT_MASK_10)
#define MSG_BUILD_MASK_MSG_SSID_WEAR_AON_ML_APPS                    (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_WEAR_AON_LOG_PROXY                  (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_WEAR_AON_POWER_DB                   (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_WEAR_AON_REF_APP                    (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_WEAR_AON_AUDIOMANAGER               (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_WEAR_AON_PMIC                       (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_WEAR_AON_COREBSP_AUDIO              (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_WEAR_AON_AUDIOSS                    (MSG_LVL_LOW)

/* FW_CSM related SSID's  */
#define MSG_BUILD_MASK_MSG_SSID_FW_CSM_CPLANE_CMN                                   (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_FW_CSM_CPLANE_CFG                                   (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_FW_CSM_CPLANE_DL                                    (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_FW_CSM_CPLANE_UL                                    (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_FW_CSM_L1API_CMN                                    (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_FW_CSM_L1API_CFG                                    (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_FW_CSM_L1API_WP                                     (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_FW_CSM_L1API_RPT                                    (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_FW_CSM_L1API_UT                                     (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_FW_CSM_FAPI_CMN                                     (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_FW_CSM_QDU_Q6_MVT                                   (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_FW_CSM_IMPS_CMN                                     (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_FW_CSM_IMPS_ADAPTER_CMN                             (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_FW_CSM_MPLANE_CMN                                   (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_FW_CSM_RUMGR                                        (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_FW_CSM_TIMETRIG                                     (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_FW_CSM_AXIDMA_CMN                                   (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_FW_CSM_MCXDMA_CMN                                   (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_FW_CSM_DMAMEMCPY_CMN                                (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_FW_CSM_DANIPC_CMN                                   (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_FW_CSM_ORAN                                         (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_CSM_DU_FAPI                                         (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_CSM_DU_L1API                                        (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_CSM_DU_CPLANE                                       (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_CSM_DU_MPLANE                                       (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_CSM_DU_IMPS                                         (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_CSM_DU_TIMETRIG                                     (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_CSM_DU_RUMGR                                        (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_CSM_DU_ORAN                                         (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_CSM_DU_AXIDMA                                       (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_CSM_DU_MCXDMA                                       (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_CSM_DU_DMAMEMCPY                                    (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_CSM_DU_DANIPC                                       (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_FW_CSM_TENX                                         (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_FW_CSM_SP                                           (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_FW_CSM_SYSLOG                                       (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_CSM_DU_DIAG_LOG                                     (MSG_LVL_LOW)

/* CSM_ORAN related SSID's  */
#define MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_SPLANE                     (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_SPLANE_PTP                 (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_SPLANE_SYNCE               (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_SPLANE_OSAL                (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_SPLANE_TEST                (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_MPLANE_RU_RU               (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_MPLANE_RU_SRP              (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_MPLANE_RU_NP               (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_MPLANE_RU_YMI              (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_MPLANE_DU_NCB              (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_MPLANE_DU_AP               (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_MPLANE_DU_OAM              (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_MPLANE_DUMAN_SIM           (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_MPLANE_MACE_SIM            (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_MPLANE_QNET_SIM            (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_MPLANE_RUMAN_SIM           (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_MPLANE_SPLANE_SIM          (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_MPLANE_RU_OEM              (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_SPLANE_ACCUTIME            (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_SPLANE_GPS_UTILITY         (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_TRANSCEIVER                (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_FMGR_GENERIC               (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_FMGR_PERIODIC              (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_PWRMGR_GENERIC             (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_CSM_ORAN_EPE_GENERIC                (MSG_LVL_LOW)
