...
# Copyright (c) 2007-2011, 2016, 2018-2021, 2024 Qualcomm Technologies, Inc.
# All Rights Reserved.
...
============================================================================*/
  void diagpkt_commit_dcm (uint8_t *ptr);
...
/*===========================================================================
FUNCTION DIAG_QUERY_MAX_CMD_REQ_SIZE
DESCRIPTION
	This function returns the maximum supported command-request size,
	that can be submitted to diag.
RETURN VALUE
	Maximum supported command-request length.
*/
uint32 diag_query_max_cmd_req_size(void);

/*===========================================================================
FUNCTION DIAG_QUERY_MAX_CMD_RSP_SIZE
DESCRIPTION
	This function returns the maximum supported command-response size,
	that can be submitted to diag.
RETURN VALUE
	Maximum supported command-response size.
*/
