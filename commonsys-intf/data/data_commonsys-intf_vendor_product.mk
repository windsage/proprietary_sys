...
IMS_RCS_VND_HAL += vendor.qti.ims.rcsconfig@2.0.vendor
IMS_RCS_VND_HAL += vendor.qti.ims.callcapability@1.0.vendor
IMS_RCS_VND_HAL += com.qualcomm.qti.uceservice@2.2.vendor
IMS_RCS_VND_HAL += vendor.qti.ims.rcsconfig@2.1.vendor
IMS_RCS_VND_HAL += com.qualcomm.qti.uceservice@2.3.vendor



CNE_VND_HAL  := vendor.qti.hardware.data.dynamicdds@1.0.vendor
CNE_VND_HAL  := vendor.qti.hardware.data.dynamicdds@1.1.vendor
...
CNE_VND_HAL  += vendor.qti.hardware.data.lce@1.0.vendor
CNE_VND_HAL  += vendor.qti.hardware.data.flow@1.0.vendor
CNE_VND_HAL  += vendor.qti.hardware.data.flow@1.1.vendor
CNE_VND_HAL  += vendor.qti.latency@2.0.vendor
CNE_VND_HAL  += vendor.qti.latency@2.1.vendor
CNE_VND_HAL  += vendor.qti.latency@2.2.vendor
CNE_VND_HAL  += vendor.qti.hardware.data.latency@1.0.vendor
CNE_VND_HAL  += vendor.qti.data.mwqem@1.0.vendor
