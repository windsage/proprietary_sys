...
LOCAL_MODULE        := VtsImsConfigServiceTest_1_1
LOCAL_MODULE_TAGS   := optional
LOCAL_CFLAGS        := -O0 -g

LOCAL_SRC_FILES     += ImsConfigCommon.cpp
...
LOCAL_SRC_FILES     += ImsConfigBackwardCompatibilityTest.cpp
LOCAL_SRC_FILES     += ImsConfigTriggerAcsTest.cpp
