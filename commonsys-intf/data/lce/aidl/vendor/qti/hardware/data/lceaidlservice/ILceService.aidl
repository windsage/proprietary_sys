...
import vendor.qti.hardware.data.lceaidlservice.Action;
import vendor.qti.hardware.data.lceaidlservice.ILceIndication;
import vendor.qti.hardware.data.lceaidlservice.StatusCode;
...
interface ILceService {
     ...
     *
     * @return Returns OK or REPORTING_CRITERIA_NOT_SET if
     *      setLinkCapacityReportingCriteria() hasn't been called.
     */
    StatusCode getLastEstimationReport();
     ...
     *
     */
    oneway void performReportingAction(in Action action);
     ...
     */
    oneway void setCallback(in ILceIndication callback);
     ...
     *
     * Response callback is ILceIndication.linkEstimation().
     *
     ...
     *
     * @return Returns OK or REPORTING_CRITERIA_TYPE_MISMATCH if previous criteria used a
     *      different reporting type {THRESHOLD, TIME}.
     */
    StatusCode setLinkCapacityReportingCriteria(in int reportingPeriod, in int hysteresisMs,
        in int[] thresholdsDownlinkKbps, in int[] thresholdsUplinkKbps,
        in AccessNetwork accessNetwork);
}
