...
#define DITHER_ENTRIES_EXT_SIZE (16 * 16)
...
#define DISP_GC_FLAGS_USE_HIGH_PREC_OUTPUT 0x00000002
#define GC_ENTRIES_SIZE 1024
#define GC_ENTRIES_SIZE_EXT 256
...
#define DISP_IGC_FLAGS_HIGH_PREC_EN (1 << 1)
...
struct lut_info -- structure for defining the various igc or gc lut information
  ...
  entries_ext   -- extended entries to support high presion mode
*/
struct lut_info {
  uint32_t flags;
  ...
  uint32_t r_entries_ext[GC_ENTRIES_SIZE_EXT];
  uint32_t g_entries_ext[GC_ENTRIES_SIZE_EXT];
  uint32_t b_entries_ext[GC_ENTRIES_SIZE_EXT];
};
...
#define DISP_DITHER_OFFSET_ENABLE (1 << 1)
#define DISP_DITHER_MATRIX_SELECT_NONE 0
#define DISP_DITHER_MATRIX_SELECT_4_4 1
#define DISP_DITHER_MATRIX_SELECT_6_6 2
#define DISP_DITHER_MATRIX_SELECT_8_8 3
#define DISP_DITHER_MATRIX_SELECT_16_16 4
struct dither_coeff_data {
  ...
  int32_t ext_entries[DITHER_ENTRIES_EXT_SIZE];
};
