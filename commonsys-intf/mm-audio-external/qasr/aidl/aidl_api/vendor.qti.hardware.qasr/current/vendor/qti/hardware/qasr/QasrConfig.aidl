...
parcelable QasrConfig {
   ...
   */
  vendor.qti.hardware.qasr.QasrConfig.LanguageCode input_language_code = vendor.qti.hardware.qasr.QasrConfig.LanguageCode.EN_US;
  /**
   * @deprecated Output language detection code.
   */
  vendor.qti.hardware.qasr.QasrConfig.LanguageCode output_language_code = vendor.qti.hardware.qasr.QasrConfig.LanguageCode.EN_US;
