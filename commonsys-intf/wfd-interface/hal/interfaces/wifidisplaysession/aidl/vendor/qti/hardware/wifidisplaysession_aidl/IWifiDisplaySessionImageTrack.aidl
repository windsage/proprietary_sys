...
import vendor.qti.hardware.wifidisplaysession_aidl.IWifiDisplaySessionImageTrackCb;
...
interface IWifiDisplaySessionImageTrack {
    ...
    void createMediaTrack(in long trackObj, in long clientdata,
        in IWifiDisplaySessionImageTrackCb cb, out long[] status, out long[] instanceId, in String trackValidation);
