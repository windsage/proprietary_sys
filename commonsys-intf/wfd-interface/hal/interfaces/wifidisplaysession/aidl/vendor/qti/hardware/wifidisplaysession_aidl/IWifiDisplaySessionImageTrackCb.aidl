/* ==============================================================================
 * IWifiDisplaySessionImageTrackCb.aidl
 *
...
import vendor.qti.hardware.wifidisplaysession_aidl.ImageInfo;

@VintfStability
interface IWifiDisplaySessionImageTrackCb {
    ...
    // Adding return type to method instead of out param int status since there is only one return value.
    int trackInfoUpdated(in long clientdata, in ImageInfo info);
