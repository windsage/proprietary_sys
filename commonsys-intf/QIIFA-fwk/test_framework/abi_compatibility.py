...
class ABICompatibility(CompatibilityCheck):
    ...
    def _run_type_abi_cmd(self):
        ...
        comp_cmd = 'bash build.sh -j64 dist --target_only' \
                   ' --tech_package=techpackage-unittest'
    ...
    def _run_check_golden_dumps(self, library_name):
        ...
        commands_lst = ['cd $ANDROID_BUILD_TOP',
                        'cd vendor/qcom/proprietary/commonsys-intf/QIIFA-cmd/abi-dumps/unittest/abi-dumps/techpackages/techpackage-unittest/arm64/',
                        'ls -ltr ' + library_name]
    ...
    def _run_check_lsdumps(self, library_name):
        ...
        commands_lst = ['cd $ANDROID_BUILD_TOP',
                        'cd out/target/product/pineapple/qiifa_pineapple_current_cmd/abi-dumps/techpackages/techpackage-unittest/arm64/',
                        'ls -ltr ' + library_name]
        err = run_cmd(commands_lst)['stderr']
        return err
