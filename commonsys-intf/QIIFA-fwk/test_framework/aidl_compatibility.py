...
from aidl_tc_methods import AIDLTCMethods
from utils import run_cmd, copy_file


class AIDLCompatibility(CompatibilityCheck):

    _copy_dir_name = 'copy_dir'

    def __init__(self):
        super(AIDLCompatibility, self).__init__()
        self._aidl_tc_methods = AIDLTCMethods()
