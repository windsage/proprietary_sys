...
class ABISetup(object):
    ...
    _unittest_conf_name = 'techpackage-unittest.json'
    ...
    def update_target_mk(self):
        ...
        """
        commands_lst = ['more ' + self._abs_path(self._target_file) + ' | grep libTestCase | wc -l']
    ...
    def compile_from_croot(self):
        ...
        comp_cmd = 'bash build.sh -j64 dist --target_only' \
                   ' --tech_package=techpackage-unittest:golden'
