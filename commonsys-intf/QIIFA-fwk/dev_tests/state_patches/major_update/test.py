...
class QiifaTest(unittest.TestCase):
    ...
    def test(self):
        self.assertGreater(str(self.actual_result).find("Major update detected for the component"), -1,self.actual_result)
        self.assertGreater(str(self.actual_result).find("Kindly delete GRD"), -1,self.    actual_result)
