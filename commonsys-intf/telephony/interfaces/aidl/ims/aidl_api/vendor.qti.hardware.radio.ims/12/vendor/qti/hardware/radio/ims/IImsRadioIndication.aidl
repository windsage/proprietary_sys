...
interface IImsRadioIndication {
  ...
  oneway void onPreAlertingCallInfoAvailable(in vendor.qti.hardware.radio.ims.PreAlertingCallInfo info);
  oneway void onIncomingCallAutoRejected2(in vendor.qti.hardware.radio.ims.AutoCallRejectionInfo2 autoCallRejectionInfo);
  oneway void onCiWlanNotification(in vendor.qti.hardware.radio.ims.CiWlanNotificationInfo type);
  oneway void onSrtpEncryptionStatusChanged(in vendor.qti.hardware.radio.ims.SrtpEncryptionInfo info);
}
