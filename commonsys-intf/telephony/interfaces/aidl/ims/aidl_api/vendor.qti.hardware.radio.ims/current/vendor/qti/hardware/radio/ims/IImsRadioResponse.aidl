...
interface IImsRadioResponse {
  ...
  oneway void queryMultiSimVoiceCapabilityResponse(in int token, in vendor.qti.hardware.radio.ims.ErrorCode errorCode, in vendor.qti.hardware.radio.ims.MultiSimVoiceCapability voiceCapability);
  oneway void exitSmsCallBackModeResponse(in int token, in vendor.qti.hardware.radio.ims.ErrorCode errorCode);
  oneway void sendVosSupportStatusResponse(in int token, in vendor.qti.hardware.radio.ims.ErrorCode errorCode);
  oneway void sendVosActionInfoResponse(in int token, in vendor.qti.hardware.radio.ims.ErrorCode errorCode);
  oneway void setGlassesFree3dVideoCapabilityResponse(in int token, in vendor.qti.hardware.radio.ims.ErrorCode errorCode);
  oneway void abortConferenceResponse(in int token, in vendor.qti.hardware.radio.ims.ErrorCode errorCode);
}
