...
interface IQtiRadio {
  ...
  vendor.qti.hardware.radio.qtiradio.CellularRoamingPreference getCellularRoamingPreference();
  oneway void setCellularRoamingPreference(in int serial, in vendor.qti.hardware.radio.qtiradio.CellularRoamingPreference pref);
  boolean isCiwlanAvailable();
  oneway void setCiwlanModeUserPreference(in int serial, in vendor.qti.hardware.radio.qtiradio.CiwlanConfig ciwlanConfig);
  vendor.qti.hardware.radio.qtiradio.CiwlanConfig getCiwlanModeUserPreference();
  oneway void queryNrIcon(in int serial);
  oneway void sendAllEsimProfiles(in int serial, in boolean status, in @nullable List<String> iccIds, in int referenceNum);
