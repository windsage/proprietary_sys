...
interface IQtiRadioResponse {
  ...
  oneway void getNetworkSelectionModeResponse(in int serial, in int errorCode, in vendor.qti.hardware.radio.qtiradio.NetworkSelectionMode mode);
  ...
  oneway void onNrIconResponse(in int serial, in int errorCode, in vendor.qti.hardware.radio.qtiradio.NrIcon icon);
