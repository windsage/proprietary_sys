...
interface IQtiRadioConfigIndication {
  ...
  oneway void onDualDataRecommendation(in vendor.qti.hardware.radio.qtiradioconfig.DualDataRecommendation rec);
  oneway void onCiwlanCapabilityChanged(in vendor.qti.hardware.radio.qtiradioconfig.CiwlanCapability capability);
