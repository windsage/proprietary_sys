...
# This makefile is getting included twice, hence add a check to include
# overlay path only once to avoid compilation error.
OVERLAY_PATH := vendor/qcom/proprietary/common/msm8937_32go/overlay
ifeq (,$(findstring $(OVERLAY_PATH), $(DEVICE_PACKAGE_OVERLAYS)))
# overlay path not present in DEVICE_PACKAGE_OVERLAYS. So add it.
  DEVICE_PACKAGE_OVERLAYS += $(OVERLAY_PATH)
endif
