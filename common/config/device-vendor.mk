...
ifeq ($(filter $(TARGET_BOARD_PLATFORM), kona lito bengal monaco),$(TARGET_BOARD_PLATFORM))
...
PRODUCT_LIST := cuttlestone_x86_phone
...
ADSPRPC += adsprpcd
ifneq ($(filter $(TARGET_BOARD_PLATFORM), msm8953 msm8937 monaco),$(TARGET_BOARD_PLATFORM))
...
FINGERPRINT += android.hardware.biometrics.fingerprint@2.1.vendor
...
HY11_HY22_diff += libavservices_minijail.vendor
...
#MM_AUDIO
# For automotive targets, MM_AUDIO
# packages are in audio_vendor_product.mk
ifneq ($(TARGET_BOARD_AUTO),true)
MM_AUDIO := acdbtest
MM_AUDIO += audiod
...
MM_AUDIO += MTP_Orchid_Bluetooth_cal.acdb
MM_AUDIO += MTP_Orchid_General_cal.acdb
MM_AUDIO += MTP_Orchid_Global_cal.acdb
MM_AUDIO += MTP_Orchid_Handset_cal.acdb
MM_AUDIO += MTP_Orchid_Hdmi_cal.acdb
MM_AUDIO += MTP_Orchid_Headset_cal.acdb
MM_AUDIO += MTP_Orchid_Speaker_cal.acdb
MM_AUDIO += MTP_Orchid_workspaceFile.qwsp
...
MM_AUDIO += fai_2.0.0_0.1_eai_1.00.pmd
MM_AUDIO += fai_2.3.0_0.1_eai_1.00.pmd
...
MM_AUDIO += IDP_Shima_Bluetooth_cal.acdb
MM_AUDIO += IDP_Shima_General_cal.acdb
MM_AUDIO += IDP_Shima_Global_cal.acdb
MM_AUDIO += IDP_Shima_Handset_cal.acdb
MM_AUDIO += IDP_Shima_Hdmi_cal.acdb
MM_AUDIO += IDP_Shima_Headset_cal.acdb
MM_AUDIO += IDP_Shima_Speaker_cal.acdb
MM_AUDIO += IDP_Shima_workspaceFile.qwsp
MM_AUDIO += IDPS_Shima_Bluetooth_cal.acdb
MM_AUDIO += IDPS_Shima_General_cal.acdb
MM_AUDIO += IDPS_Shima_Global_cal.acdb
MM_AUDIO += IDPS_Shima_Handset_cal.acdb
MM_AUDIO += IDPS_Shima_Hdmi_cal.acdb
MM_AUDIO += IDPS_Shima_Headset_cal.acdb
MM_AUDIO += IDPS_Shima_Speaker_cal.acdb
MM_AUDIO += IDPS_Shima_workspaceFile.qwsp
MM_AUDIO += QRD_Shima_Bluetooth_cal.acdb
MM_AUDIO += QRD_Shima_General_cal.acdb
MM_AUDIO += QRD_Shima_Global_cal.acdb
MM_AUDIO += QRD_Shima_Handset_cal.acdb
MM_AUDIO += QRD_Shima_Hdmi_cal.acdb
MM_AUDIO += QRD_Shima_Headset_cal.acdb
MM_AUDIO += QRD_Shima_Speaker_cal.acdb
MM_AUDIO += QRD_Shima_workspaceFile.qwsp
...
MM_AUDIO += MTP_SKU1_Bluetooth_cal.acdb
MM_AUDIO += MTP_SKU1_Codec_cal.acdb
MM_AUDIO += MTP_SKU1_General_cal.acdb
MM_AUDIO += MTP_SKU1_Global_cal.acdb
MM_AUDIO += MTP_SKU1_Handset_cal.acdb
MM_AUDIO += MTP_SKU1_Hdmi_cal.acdb
MM_AUDIO += MTP_SKU1_Headset_cal.acdb
MM_AUDIO += MTP_SKU1_Speaker_cal.acdb
MM_AUDIO += MTP_SKU1_workspaceFile.qwsp
MM_AUDIO += QRD_SKU1_Bluetooth_cal.acdb
MM_AUDIO += QRD_SKU1_Codec_cal.acdb
MM_AUDIO += QRD_SKU1_General_cal.acdb
MM_AUDIO += QRD_SKU1_Global_cal.acdb
MM_AUDIO += QRD_SKU1_Handset_cal.acdb
MM_AUDIO += QRD_SKU1_Hdmi_cal.acdb
MM_AUDIO += QRD_SKU1_Headset_cal.acdb
MM_AUDIO += QRD_SKU1_Speaker_cal.acdb
MM_AUDIO += QRD_SKU1_workspaceFile.qwsp
...
MM_AUDIO += ftm_test_config_lito-orchidmtp-snd-card
MM_AUDIO += ftm_test_config_bengal-scubaidp-snd-card
MM_AUDIO += ftm_test_config_bengal-scubaqrd-snd-card
MM_AUDIO += ftm_test_config_lahaina-shimaidp-snd-card
MM_AUDIO += ftm_test_config_lahaina-shimaqrd-snd-card
MM_AUDIO += ftm_test_config_lahaina-shimaidps-snd-card
MM_AUDIO += ftm_test_config_holi-mtpsku1-snd-card
MM_AUDIO += ftm_test_config_holi-qrdsku1-snd-card
MM_AUDIO += ftm_test_config_holi-qrd-snd-card
...
MM_AUDIO += android.hardware.automotive.audiocontrol-service.rc
...
ifeq ($(filter $(TARGET_BOARD_PLATFORM), sdm660),$(TARGET_BOARD_PLATFORM))
#MM_CAMERA for legacy sdm660
...
MM_VIDEO += libhyp_video_intercept
...
QCRIL += vendor.qti.hardware.radio.ims@1.5
QCRIL += vendor.qti.hardware.radio.ims@1.6
QCRIL += vendor.qti.hardware.radio.ims@1.7
QCRIL += vendor.qti.hardware.radio.ims@1.8
QCRIL += vendor.qti.hardware.radio.ims@1.9
...
QCRIL += vendor.qti.hardware.radio.qtiradio@2.3
QCRIL += vendor.qti.hardware.radio.qtiradio@2.4
QCRIL += vendor.qti.hardware.radio.uim@1.0
QCRIL += vendor.qti.hardware.radio.uim@1.1
QCRIL += vendor.qti.hardware.radio.uim@1.2
...
SECUREMSM += vendor.qti.esepowermanager@1.1-service
SECUREMSM += vendor.qti.esepowermanager@1.1-impl
SECUREMSM += vendor.qti.esepowermanager@1.1-service.rc
...
ifeq ($(TARGET_BOARD_AUTO),true)
#SYSPROFILER
SYSPROFILER := libsysprofiler
SYSPROFILER += sysprofiler_app
SYSPROFILER += sysprofiler_interface
endif
...
ifeq ($(ENABLE_AIDL_VHAL), true)
VEHICLE_NETWORKS += android.hardware.automotive.vehicle
VEHICLE_NETWORKS += android.hardware.automotive.vehicle@V1-qti-service
VEHICLE_NETWORKS += carpowerusbservice
VEHICLE_NETWORKS += powerwrapper
else
...
ifneq ($(filter $(TARGET_BOARD_PLATFORM), sdm660),$(TARGET_BOARD_PLATFORM))
...
ifeq ($(filter $(TARGET_BOARD_PLATFORM), sdm660),$(TARGET_BOARD_PLATFORM))
# Add MM_CAMERA to legacy sdm660
