...
# TARGET_BOARD_PLATFORM is for all qcom targets.
# For example, the possible values for TARGET_BOARD_PLATFORM are
#
...
# the following vars represent values for TARGET_BOARD_PLATFORM
# msm7627_surf
TARGET_DEVICE  := msm7627_surf
TARGET_BOARD_PLATFORM := msm7627_surf
TARGET_BOOTLOADER_BOARD_NAME := msm7627_surf

# When the release for qcom TARGET_BOARD_PLATFORM
# msm7627_surf reaches the customer, the following
# would be an example set of TARGET_BOARD_PLATFORM values
...
#    being built (specified by variables TARGET_BOARD_PLATFORM
